...
const EPISODI = { preludio: json('preludio.json'), ep1: json('ep1.json'), ep2: json('ep2.json'), ep3: json('ep3.json'), ep4: json('ep4.json'), ep5: json('ep5.json'), ep6: json('ep6.json'), ep7: json('ep7.json'), ep8: json('ep8.json'), ep9: json('ep9.json'), ep10: json('ep10.json'), ep11: json('ep11.json'), ep12: json('ep12.json'), ep13: json('ep13.json'), ep14: json('ep14.json'), ep15: json('ep15.json'), ep16: json('ep16.json'), ep17: json('ep17.json'), ep18: json('ep18.json'), ep19: json('ep19.json') };
