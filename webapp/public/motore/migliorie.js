...
export const MIGLIORIE = [
  ...
  { id: 'taccuino', nome: 'Taccuino fitto', costo: [1], dove: 'campagna',
    dice: 'Taccuino fitto: una volta per campagna, rileggete una lettera d’incarico già archiviata e contate un incrocio in più (vale come una RILETTURA). L’app non tiene il conto degli incroci: segnatelo sul Taccuino di Campagna.',
  ...
  { id: 'fiato', nome: 'Fiato lungo', costo: [2], dove: 'spedizione',
    dice: 'Fiato lungo: il vostro «Secondo fiato» si ricarica una seconda volta, la prima volta che scendete a 2 Salute o meno. In Spedizione il ritento lo tenete voi: se il tiro va male, tirate di nuovo i dadi prima di dare il totale all’app.',
