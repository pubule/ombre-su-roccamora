...
episodi = dict(
    ...
    ep14=dict(
        ...
        orologio=dict(id='fuga', nome='Fuga sui tetti', max=9, ogni=1,
                      frena_adiacente='IL PRIMO GATTO',
    ...
    ep15=dict(
        ...
        orologio=dict(id='sigillo', nome='Sigillo', max=8, ogni=0, da_carta=1,
    ...
    ep17=dict(
        ...
        orologio=dict(id='decano', nome='Trasferimento', max=8, ogni=0, da_carta=1,
    ...
    ep18=dict(
        ...
        orologio=dict(id='arresto', nome='Arresto', max=9, ogni=0, da_carta=1,
    ...
    ep20=dict(
        ...
        orologio=dict(id='risveglio', nome='Risveglio', max=8, ogni=0, da_carta=1,
