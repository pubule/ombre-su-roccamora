...
LETTERA_7 = (
    ...
    "<font name=\"OldStd-Italic\"><i>Luoghi disponibili dall’inizio: la contrada di Sant’Orsola, la bottega di Fava, le "
    "Fonderie e il Banco dei Pegni. Gli altri andranno sbloccati.</i></font>")
...
TILES_7 = [
    ...
    dict(id='T6', nome='L’INTERCAPEDINE DEL TERZO PIANO', exits={'O': 'T4P', 'E': 'T5I'},
         ...
         arbitro='Liberare Fava: Interagire, nessuna prova; si muove col gruppo (Movimento '
                 ...
                 'dichiarata:</b> il Regolamento assegna 3 caselle al personaggio scortato; qui sono '
