...
LUOGHI_DESC = {
    ...
    2: 'Il vicolo dei Fonditori sa di carbone e minestra bollita, di panni stesi tra '
       ...
       'più buio della sera che scende fuori, le persiane accostate come per un lutto '
    ...
    5: 'La bottega è chiusa da giorni, la polvere ha già preso possesso delle vetrine '
       ...
       'sotto la pioggia; il vicino che la sorveglia si scosta senza una parola — ha '
       'riconosciuto, tra le vostre mani, qualcosa che apparteneva a Ferri — e la porta '
       'sul retro si apre con un cigolio che sembra un lamento, come se l’edificio '
       'stesso protestasse per l’intrusione. '
...
TESSERE_DESC = {
    'T1': 'Sa di sego, la banchina, e sotto il sego di acqua che non si muove da troppo: un '
          'odore di catino lasciato pieno, che si sente in gola prima che nel naso. Le assi '
          'del molo sono viscide della patina che il canale posa e riprende due volte al '
          'giorno, gli anelli d’ormeggio sono consumati a mezzaluna da corde che non ci sono '
          'più, e contro il muro stanno casse accatastate male, con la sabbia del carico '
          'ancora sui coperchi. Il magazzino, da questa parte, non ha finestre: solo il '
          'portone d’acqua e la porta sul retro, che non lascia passare nemmeno un filo di '
          'luce. Fa più freddo di quanto una notte di novembre in città giustifichi — un '
          'freddo che sale dall’acqua invece di scendere dal cielo — e la nebbia resta '
          'sospesa a mezz’aria sopra il canale, ferma come tutto il resto. Ogni tanto, sotto '
          'il molo, l’acqua fa un rumore di gola: inghiotte qualcosa di piccolo, si prende il '
          'suo tempo, ricomincia. All’ultimo anello, annodato stretto, resta un pezzo di cima '
          'chiara, tagliata di netto a un palmo dal nodo.',
    'T2': 'L’aria della sala sa di catrame e di legno bagnato, e sotto c’è il sego, '
          'dappertutto, come in una dispensa dove l’olio si è rovesciato una volta sola e '
          'vent’anni fa. Casse marchiate a fuoco con l’onda salgono fino a toccare le travi '
          'in corridoi che si restringono a ogni fila, tanto che in certi punti bisogna '
          'mettersi di lato e passare col fianco; la lanterna non arriva in fondo, e l’ultimo '
          'tratto di ogni corridoio resta un buio pieno di spigoli. Alcune casse sono aperte '
          'e vuote, i coperchi buttati a terra col chiodo ancora storto; altre sono chiuse e '
          'inchiodate di fresco — il legno più chiaro attorno alle teste dei chiodi — e '
          'aspettano qualcuno che non è ancora arrivato. Fra le pile qualcosa scricchiola nei '
          'momenti esatti in cui nessuno si muove, mai prima, mai dopo, come se il legno '
          'trattenesse il fiato insieme a voi. Contro la parete, dove le pile lasciano un '
          'vuoto largo quanto una cassa, sta appoggiata una sponda sola, con la paglia '
          'dell’imballo ancora incastrata nelle fessure.',
    'T3': 'Il caldo arriva prima della luce: un caldo umido, da lavanderia, che dopo l’acqua '
          'ferma della banchina sembra un torto. Migliaia di candele nere fanno del corridoio '
          'una gola di luce tremolante — appoggiate su mensole di ferro a più ordini, '
          'infilate nelle nicchie, colate le une sulle altre finché non si saldano in '
          'colonne — e le pareti stringono più di quanto un magazzino abbia motivo di '
          'stringere, incise di simboli che la fuliggine ha reso quasi illeggibili. La cera '
          'cola dalle mensole come pioggia lenta e si raccoglie in stalattiti nere sul '
          'pavimento consumato, che sotto le suole cede di un niente, tiepido. Ogni fiamma '
          'arde immobile, dritta, senza vacillare — nemmeno quando l’aria si muove al vostro '
          'passaggio: un dettaglio che il corpo nota prima della mente. Chi entra '
          'per la prima volta prova NERVI (Media): se fallisce, 1 danno (cera '
          'bollente). Su una mensola, in mezzo a tutte le altre, una sola candela è spenta e '
          'consumata a metà, e la sua cera è colata tutta da un lato.',
    'T4': 'Qui l’aria sa di sego bruciato e di panni dormiti: l’odore di una stanza abitata da '
          'uno solo, che non apre mai. La scrivania è sommersa di spartiti annotati con '
          'grafia febbrile, righe e correzioni che si accavallano fino a diventare '
          'illeggibili verso i bordi del foglio, come se la mano che scriveva avesse perso '
          'ogni pazienza con lo spazio a disposizione; di fianco, un pagliericcio disfatto '
          'che puzza di sego e di sudore antico, coperte ammucchiate più che piegate, una '
          'mensola di vasetti allineati per altezza. Non c’è uno specchio, non c’è '
          'un’immagine sacra, non c’è niente che serva a guardare o a farsi guardare. La '
          'tazza sul comodino è ancora tiepida al tatto — tiepida quanto una tazza lasciata '
          'il tempo di attraversare una stanza, non di più. Oltre la parete, dei passi: si '
          'fermano nell’istante esatto in cui vi fermate anche voi, e riprendono solo quando '
          'ricominciate a muovervi, sempre alla vostra andatura. Sul ripiano, tenuto fermo da '
          'un sasso di canale, un foglio è pronto e non ha una riga.',
    'T5': 'Dalla scala sale un’aria di pozzo: pietra bagnata, muffa, e in fondo quel dolce di '
          'cera che alla pietra non appartiene. I gradini scendono stretti fra pareti che '
          'sudano, consumati al centro da piedi che scendevano spesso — e risalivano chissà; '
          'la calce si stacca a scaglie dove le spalle la sfiorano, e la corda tesa da parete '
          'a parete come corrimano è marcita da un pezzo: nella mano lascia solo una polvere '
          'scura. Non c’è una lampada, non c’è un chiodo dove appenderla, non c’è segno che '
          'qui sotto qualcuno abbia mai avuto bisogno di vederci. A ogni gradino il canto che '
          'avete sentito entrando si fa meno idea e più suono: non più forte, più vicino, '
          'come una bocca che si sposta lentamente verso l’orecchio. Il freddo sale dal basso '
          'a ondate lente, col ritmo di un respiro lungo, e la fiamma della lanterna si piega '
          'verso il fondo — non verso l’uscita. A metà rampa, sul gradino consumato più degli '
          'altri, sta una candela nera dritta nella sua cera, mai accesa.',
    'T6': 'La cripta ha il fiato di una cantina in cui si è rovesciato il miele: cera, chiuso, '
          'e sotto un dolce che non dovrebbe esserci e che resta in bocca a lungo. È un '
          'polmone di pietra pieno di fiamme ferme — candele nere a centinaia sulla pietra '
          'dell’altare, nelle nicchie, per terra in cerchi — e la cera ha colato tanto a lungo '
          'da fare colonne che salgono dal pavimento alla volta, spesse come un braccio, '
          'lisce in cima e sfrangiate in basso. Qui il canto non ha più bisogno di salire: '
          'sta nell’aria come l’umido, e ogni fiamma gli tiene il tempo senza muoversi di un '
          'dito. Dietro l’altare, nell’angolo, la cella sbarrata: dentro, una sagoma che '
          'dondolava piano e che smette nell’istante in cui la vostra luce la tocca, e resta '
          'ferma con la testa girata dalla parte sbagliata rispetto alla porta. Su una delle '
          'colonne di cera, all’altezza di una mano, una colata porta l’impronta di quattro '
          'dita, presa quando era ancora molle.',
}
