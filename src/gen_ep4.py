...
LETTERA_4 = (
    ...
    "<font name=\"OldStd-Italic\"><i>Luoghi disponibili dall’inizio: il palcoscenico del Comunale, il camerino della "
...
# nuovi).
LUOGHI4_DESC = {
    1: "A sipario chiuso il palcoscenico sa di colla calda, di polvere di gesso e di quel poco "
       "di canfora che resta nei velluti: il tepore delle lampade spente da un’ora se ne va "
       "dalle tavole, e da sotto sale l’aria di cantina che il legno non ferma. Al centro, sul "
       "suo trespolo, la lampada di servizio brucia da sola per tutti — una candela accesa in "
       "una casa vuota — e attorno il legno è una piazza smisurata: le quinte in fila che si "
       "muovono agli spifferi, la ribalta con gli sportelli aperti, la buca del suggeritore "
       "vuota e in ordine, il leggio, la lampadina schermata, la sedia consumata da una parte "
    ...
    2: "Il camerino sa di cipria, di gelsomino e di gas caldo: le lampadine attorno allo "
       ...
       "artisti se ne accorge sulla fronte prima che negli occhi. Sulla cornice stanno i "
       "telegrammi infilati per la punta, i fiori di ieri sera già piegati nel loro vaso, i "
       "costumi in fila su una stanga di ferro con dentro ancora la forma delle spalle di chi "
       "li porta; in mezzo alla fila dei telegrammi c’è una puntina sola, senza carta. La "
       "signora Vetri siede dritta come in scena anche adesso che non la guarda nessuno, le "
       "mani ferme sul tavolino, e parla non verso di voi ma verso la propria faccia nello "
       "specchio: «Lo canticchio nel sonno, dice la mia cameriera. Io nel sonno non canto "
       "mai.» Mentre lo dice il gas cala di un soffio, tutte le lampadine si abbassano "
       "insieme e poi tornano — e lei non batte ciglio, come chi ci ha fatto l’abitudine. Sul "
       "piano del tavolino la pila degli spartiti è allineata al millimetro, dodici copie "
       "identiche, e sul primo foglio l’angolo alto è consumato da un pollice che l’ha "
       "voltato molte più volte di quante ne servano a leggerlo.",
    3: "Al loggione si sale per una scala di pietra che non finisce mai, e a metà salita "
       "l’aria cambia temperatura: monta il caldo di ottocento persone che ancora non ci "
       "sono, mescolato a buccia d’arancia, vino cattivo e cera da pavimenti. Le panche sono "
       "lucide come sassi di fiume, consumate al centro da generazioni di gomiti; la "
       "ringhiera di ferro è tiepida sotto le mani; il grande lampadario sta più in basso "
       "degli occhi, così che di quassù si guarda il fuoco dall’alto. Il posto d’angolo sotto "
       "la balaustra è vuoto e nessuno ci si siede: attorno la panca è nera di lucido, lì il "
       "legno è più chiaro. La claque aspetta senza il suo capo — mani che non sanno dove "
       "stare, bicchieri passati e non bevuti — e uno dei più vecchi vi sbarra il passo con "
       "l’avambraccio, non forte, come si ferma un bambino: «Rocco non è scappato con la "
       "colletta», dice, e ripete la stessa frase due volte con le stesse parole. Quando "
       "l’orchestra accorda, laggiù, la ringhiera prende la nota e la tiene un poco più a "
       "lungo di quanto la tenga l’orchestra. Sul ferro della balaustra, all’altezza del "
       "posto vuoto, restano due mezzelune lucide.",
    4: "Il Caffè dei Cantanti sa di caffè bruciato, di vinaccio e di lana bagnata messa ad "
       "asciugare troppo vicino alla stufa; segue gli orari del teatro come una marea — pieno "
       "alle sei, deserto alle otto, pieno di nuovo a mezzanotte — e a ogni cambio le sedie "
       "vengono voltate e rivoltate con lo stesso strascico di ferro sul marmo. Specchi "
       "dorati fino al soffitto, caricature dei divi appese in tre file, un pianoforte "
       "verticale scordato col coperchio chiuso e sopra i cappelli di chi non ha trovato "
       "l’attaccapanni; in mezzo alla seconda fila di caricature manca un quadro, e la carta "
       "da parati lì sotto ha tenuto il suo colore. Un copista di musica sta al tavolino "
       "d’angolo con le dita nere fino alla seconda falange, e quando gli passate accanto "
       "alza il bicchiere senza guardare in faccia nessuno: «Io l’ho solo copiato», dice, «e "
       "da quella settimana lo sogno.» Al tavolo dietro di lui i macchinisti giocano a carte "
       "e abbassano la voce quando il cameriere passa, poi la rialzano — sempre alla stessa "
       "distanza, come se contassero i passi. Sul marmo, davanti al copista, un foglio di "
       "carta da musica piegato in quattro sta fermo sotto un bicchiere.",
    5: "Dalla porta di servizio si sente prima l’odore che il buio: catrame caldo, canapa, "
       "grasso d’argano e la terra umida che sta sotto il piano del palco e non asciuga mai. "
       "È la stiva rovesciata di una nave — travi incatramate a due palmi dalla testa, funi "
       "che salgono nel nero come sartie senza che si veda dove finiscono, sacchi di sabbia "
       "appesi in file pazienti, sabbia di ricambio nei mucchi lungo il muro — e ogni volta "
       "che di sopra qualcuno cammina, dal tavolato scende un filo di polvere dritto e "
       "sottile. Contro la parete di destra stanno in fila i pannelli curvi, numerati a "
       "gesso, appoggiati l’uno sull’altro come piatti in rastrelliera: si contano, e nella "
       "conta un numero salta. Il capomacchinista tiene la porta con l’avambraccio e il corpo "
       "di traverso, e mentre parla non guarda voi ma il fondo del locale, dove il pavimento "
       "si apre: «giù non si scende, ordine della direzione», dice, e il braccio non si "
       "sposta di un dito. Sul montante accanto alla porta un chiodo regge una lanterna "
       "spenta, e il vetro è stato pulito da poco.",
    6: "Il vicolo dell’Armonia è largo quanto due persone e in casa Alboni si entra "
       "portandosi dietro il suo freddo: dentro sa di cera bruciata, di feltro e di caffè "
       "lasciato a metà, e nel camino non c’è la cenere di un fuoco recente. Lo studio è la "
       "stanza di un uomo ordinato che non dorme — il pianoforte a mezza coda col coperchio "
       "alzato, le partiture in pile geometriche alte come sedie, il metronomo fermo con la "
       "lente in cima alla stecca, le candele consumate fino al piattino e mai smoccolate — e "
       "sulla parete sopra lo strumento un rettangolo di carta più chiara, col chiodo ancora "
       "piantato. La governante vi tiene sulla soglia, le mani incrociate sul grembiule e la "
       "porta socchiusa contro la spalla: «il maestro prova e non riceve», dice, e non si "
       "scosta nemmeno quando le si parla da vicino. Ogni tanto, dalla stanza, il pianoforte "
       "risponde da solo a un carro che passa in strada: una corda, sempre la stessa, e poi "
       "silenzio. Sul leggio sta una sola pagina aperta, e quattro battute sono cerchiate a "
       "matita rossa, ripassate tante volte che la carta si è aperta sotto la punta.",
    7: "L’archivio sa di colla vecchia, di tela e di quella polvere asciutta che si posa "
       "sulla lingua: è la chiesa di carta del teatro, scaffali di spartiti rilegati fino a "
       "un soffitto che la lampada non arriva a schiarire, e il freddo qui è un freddo "
       "voluto, tenuto basso perché la carta duri più a lungo degli uomini che l’hanno "
       "scritta. Una scala a rotelle è appoggiata alla scaffalatura di mezzo; una scrivania "
       "col paralume verde tinge di verde le mani di chi si china; sul ripiano più basso, tre "
       "scatole di cartone portano la stessa etichetta, rifatta in quarant’anni d’inchiostri "
       "diversi. L’archivista non alza gli occhi dal registro e vi parla dando le spalle, un "
       "dito fermo sulla riga dove era arrivato: «qui si entra per consultare, non per "
       "curiosare», dice, e quel dito non si muove per tutto il tempo che restate. La scala, "
       "che nessuno tocca, scivola di un palmo lungo la sua guida e si ferma; poi lo rifà. "
       "Nella terza scatola, fra i dorsi allineati, resta un vuoto largo un pollice, e sul "
       "ripiano la polvere non ha ancora coperto il rettangolo che c’era.",
    8: "Il ridotto è tutto specchi, stucchi e cera da pavimenti, e ci si cammina più piano di "
       "quanto si vorrebbe: il tappeto mangia i passi, e nel silenzio si sente il proprio "
       "respiro tornare indietro dagli angoli. Nelle vetrine dell’amministrazione stanno i "
       "registri dei palchi rilegati in rosso, un anno per volume, coi numeri d’oro sul "
       "dorso; sul banco, la penna nel calamaio e la carta assorbente ancora umida; alla "
       "parete, la fila dei ritratti dei sovrintendenti si interrompe una volta, e in quel "
       "punto il damasco non è sbiadito come attorno. Il segretario vi viene incontro con le "
       "mani in avanti, con la cortesia di chi accompagna alla porta mentre saluta: "
       "«l’amministrazione riceve su appuntamento», dice, e intanto vi ha già girati verso il "
       "corridoio. In fondo al corridoio di velluto il palco tredici ha una porta uguale a "
       "tutte le altre, e l’ottone della maniglia è opaco per tutta la sua lunghezza. Dentro, "
       "l’aria è ferma e la polvere sta su ogni cosa in uno strato uguale, tranne che sul "
       "davanzale di velluto, dove è interrotta da un contorno pulito e preciso.",
    9: "Il capannone degli scenografi sa di trementina, di colla di pelle scaldata e di "
       "segatura bagnata, e ci si entra come in una serra: le stufe restano accese giorno e "
       "notte perché il colore tiri, e il caldo appanna il vetro alto delle finestre a nord. "
       "I fondali stanno tesi sui telai come vele in secca, tre piani di tela dipinta, e le "
       "impalcature corrono davanti a un cielo lasciato a metà, azzurro in basso e ancora "
       ...
       "dall’acqua secondo la venatura, e in un punto è marchiato a fuoco.",
}
...
TESSERE_DESC_4 = {
    'T1': "La porta di servizio si chiude e l’odore del canale resta fuori di colpo: qui sotto "
          "si respira segatura, gesso da modellatore e cera vecchia sui legni, e fa più caldo "
          "di quanto una cantina al livello dell’acqua abbia diritto di essere. Casse "
          "sventrate accatastate a due altezze, cime arrotolate a otto e appese ai pioli, "
          "mezza carrozza di cartapesta appoggiata al muro con le stanghe in aria e una ruota "
          "sola; contro la parete, il segno netto di una cassa tolta da poco dalla polvere di "
          "gesso. Sopra le teste passa l’orchestra: non le note, il peso delle note — un "
          "calore basso che arriva dalle assi prima che dalle orecchie, e le assi sono a due "
          "dita dai vostri capelli. Quando di sopra il pubblico applaude, dalle fessure del "
          "tavolato scende polvere in righe sottili, tutte insieme, e resta sospesa nella "
          "luce della lanterna finché non ricomincia. Sul pavimento, dove si scarica, "
          "qualcuno ha tracciato col gesso un quadrato e dentro un numero, e il gesso è "
          "fresco.",
    'T2': "I fondali arrotolati stanno in piedi contro i cavalletti come i tronchi di un "
          "bosco piantato dall’uomo: tela, colla e polvere, un odore secco che chiude la "
          "gola, e fra un rotolo e l’altro corridoi larghi quanto una spalla, storti, che non "
          "portano dove sembrano portare. La lanterna tira fuori dal buio pezzi di mondi "
          "finiti: una città dipinta che si interrompe a mezz’aria dove finisce il telo, un "
          "giardino con la panchina e nessuno, un cielo stellato che dorme in piedi e ha le "
          "stelle grandi come piatti perché di lassù si vedano. Una porta dipinta è socchiusa "
          "su un muro; una finestra dipinta dà sul buio vero. La temperatura è quella di una "
          "chiesa, e i passi tornano indietro smorzati, come se la tela li bevesse. Ogni "
          "tanto un rotolo si assesta sul suo cavalletto — un cigolio secco, poi il silenzio, "
          "e i teli davanti si muovono un poco tutti insieme. Contro la parete di fondo, "
          "appoggiata alle scene, sta una scala di legno col primo piolo rifatto di legno "
          "nuovo.",
    'T3': "La sala dei contrappesi sa di canapa, di grasso d’argano e di sabbia asciutta, e "
          "l’aria vibra piano come dentro una cassa armonica: sacchi in file verticali fino "
          "al buio del soffitto, tamburi di legno grandi come ruote di mulino, funi tese che "
          "salgono e spariscono dove la lanterna non arriva. In basso le funi di manovra sono "
          "legate alle bitte come cime al molo, ciascuna col suo cartellino d’ottone; su un "
          "montante, la fila dei chiodi per gli attrezzi ha un chiodo vuoto in mezzo. Quando "
          "di sopra cambia la scena, qui tutto TIRA: un fischio di canapa, un tonfo sordo, un "
          "sacco che piomba dove un attimo fa non c’era niente. Fra un movimento e l’altro le "
          "corde continuano a spostarsi di un dito, avanti e indietro, senza che nessuno le "
          "tocchi, e il legno dei tamburi risponde con uno scricchiolio sempre alla stessa "
          "altezza. Contro la parete, dove la vernice è consumata, una stanga di ferro sta in "
          "verticale, e la sua estremità è lucida per un palmo.",
    'T4': "Il corridoio dei camerini chiusi ha l’odore che hanno le case dopo un lutto: "
          "chiuso, cipria vecchia, un principio di muffa nella tappezzeria, e un freddo che "
          "non viene da fuori ma dai muri stessi. Le porte sono accostate e non chiuse, una "
          "fila di fessure nere; sulle targhette d’ottone i nomi sono sbiaditi fino a due o "
          "tre lettere, e su una targhetta il nome è stato tolto e lì l’ottone è più chiaro. "
          "Dentro, gli specchi stanno sotto i lenzuoli come mobili in una casa che si lascia "
          "per l’estate, e una vestaglia appesa dietro una porta tiene ancora la forma delle "
          "spalle di qualcuno. La polvere qui non è abbandono: è silenzio depositato, alto un "
          "dito sui davanzali e intatto — tranne che sul pavimento, dove una striscia lucida "
          "corre nel mezzo per tutta la lunghezza del corridoio. A ogni passo uno dei "
          "lenzuoli si gonfia piano e ricade, sempre lo stesso, sempre con lo stesso ritardo. "
          "In fondo il corridoio si divide in due, e all’imbocco, per terra, c’è una matita "
          "spezzata a metà.",
    'T5': "La fossa si apre sotto il piano del palco come una stiva dentro la stiva: legno "
          "annerito dal tempo e dal fumo, pareti di tavole verticali, e un’aria che sa di "
          "grasso d’argano, di canapa e di corpi tenuti troppo a lungo nello stesso posto. Il "
          "grande contrappeso pende sopra il vuoto, fermo, con la sua fune che sale nel nero; "
          "l’argano è stato ingrassato di fresco e luccica di un luccichio che nel resto del "
          "sottopalco non c’è. Sul fondo, quattro metri più giù, due coperte militari, una "
          "cesta rovesciata, un boccale — e due uomini legati che alzano gli occhi insieme "
          "quando la luce li trova, senza sussultare, come chi ha già imparato a che ora "
          "arriva la lanterna. Vivi. Il più vecchio ha le mani del suo mestiere, i "
          "polpastrelli consumati dalla carta, e le tiene ferme in grembo. Sopra di voi, "
          "senza che nessuno lo tocchi, il contrappeso gira lentissimo su se stesso, prima in "
          "un verso e poi nell’altro. Sul bordo della fossa, dove ci si appoggia per calarsi, "
          "il legno porta due solchi lisci alla distanza esatta di due mani.",
    'T6': "Il ventre della conchiglia è l’interno di uno strumento grande come una casa: i "
          "pannelli curvano sopra la testa e si chiudono ai fianchi, fasciame biondo e scuro "
          "accostato senza un chiodo in vista, e il legno è tiepido al tocco come una cosa "
          "che è stata al sole. Non c’è polvere qui dentro, su niente — e in un sottopalco "
          "questo è più strano di qualunque rumore. L’orchestra è oltre le assi, a un palmo: "
          "non la si ascolta, la si riceve, e arriva come arriva la musica a chi ha la testa "
          "sott’acqua, tutta insieme e senza parole. I pannelli VIBRANO, e la vibrazione "
          "passa dal legno alle suole e dalle suole alle ginocchia, tanto che parlarsi costa. "
          "Su una rastrelliera addossata alla parete stanno in fila le lastre di cera incise, "
          "ciascuna nella sua custodia di cartone, allineate come piatti puliti; quando "
          "l’orchestra cresce tremano tutte insieme, di un tremito che si vede e non si "
          "sente. In mezzo al pavimento un cerchio di assi più chiare segna il punto dove la "
          "curva raccoglie, e lì il legno è consumato come la soglia di una chiesa.",
}
