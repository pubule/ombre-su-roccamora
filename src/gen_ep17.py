...
LETTERA_17 = (
    ...
    "<font name=\"OldStd-Italic\"><i>Luoghi disponibili dall’inizio: lo Studio del Decano, l’Assemblea della Società (il Palazzo "
    ...
    "vivo, gli eroi hanno −1 ai NERVI.</i></font>")
...
def soluzione():
    ...
    pagina('soluzione — non aprire', [
        ...
        'restano uniti come promesso: <b>lo scisma non vi costa nessun alleato in più, non applicate '
        ...
        'l’<b>alleato in più</b> che lo scisma vi costa: <b>rimuovete il Referto «La carrozza che '
        ...
        'Approfondimenti</b>. È l’alleato che quel ramo aveva messo in conto; il vantaggio '
