...
LETTERA_8 = (
    ...
    "<font name=\"OldStd-Italic\"><i>Luoghi disponibili dall’inizio: l’Osteria della Bilancia, il Banco dei Pegni, la "
    "Taverna della Chiatta e il Monte di Pietà. Gli altri andranno sbloccati.</i></font>")
...
def soluzione():
    ...
    pagina('soluzione — non aprire', [
        ...
        'lista degli acquirenti: una conferma in più alla Domanda 1; ma Sant’Orsola è rimasta '
