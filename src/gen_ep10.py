...
LETTERA_10 = (
    ...
    "<font name=\"OldStd-Italic\"><i>Luoghi disponibili dall’inizio: la casa che ricorda, la Corte della Faenza, l’Archivio "
    "Civico e la Gendarmeria. Gli altri andranno sbloccati.</i></font>")
...
LUOGHI10_DESC = {
    1: "Sa di calce nuova, e la calce nuova a novembre non dovrebbe sapere di niente: qui invece "
       "prende in gola già dalla soglia, forte come in un cantiere di luglio. Dentro, l’intonaco è "
       "chiaro e liscio senza una crepa — troppo liscio per una casa d’affitto della corte —, e "
       "restano le assi del ponteggio accatastate contro la ringhiera, la sedia rovesciata "
       ...
       "per due, e una delle due forchette è ancora appoggiata al bordo del piatto.",
    2: "Alle sei di sera la Corte della Faenza sa di minestra e di panni bagnati, e appena il "
       "freddo si posa l’odore del pozzo sale sopra gli altri: acqua ferma, pietra, un principio "
       "di ruggine. Tre piani di ballatoi chiudono il cortile come le pareti di un secchio, i "
       "panni stesi gocciolano nel vuoto uno dopo l’altro, e le voci girano lungo le ringhiere "
       "finché arrivano dove non erano dirette — una cosa detta al primo piano si sente al terzo "
       "prima che chi l’ha detta abbia finito. Le donne al lavatoio smettono di battere i panni "
       "quando passate, e riprendono dopo, tutte insieme, con una battuta di ritardo. Un vecchio "
       "col mento sul bastone vi lascia arrivare fino a lui prima di parlare, e non alza gli occhi "
       "dal selciato: «stanotte, verso l’una, ho sentito i colpi», dice, e batte due volte il "
       "bastone per farvi sentire la cadenza. Alla porta della casa in fondo, la terza, la vernice "
       "è nuova e la maniglia è d’ottone lucido; sulle altre porte della corte le maniglie sono di "
       "ferro nero.",
    3: "Carta vecchia, colla animale, polvere: l’Archivio Civico ha l’odore dolciastro di una "
       "dispensa dimenticata, e un freddo secco che non viene dalle finestre ma dagli scaffali, "
       "come se tutta quella carta lo tenesse in serbo dall’inverno scorso. Gli scaffali corrono "
       "fino al soffitto in corridoi numerati a vernice, le scale a rotelle sono legate con la "
       "catena, e sui tavoli di lettura, sotto le lampade verdi, i registri aperti aspettano da "
       "chissà quando coi nastri di stoffa penzoloni. Un impiegato pignolo, i mezzi guanti "
       "tagliati sulle dita, tira giù le filze del 1879 senza farsi dire due volte l’anno, e "
       "mentre le posa dice, come si dice una cosa ovvia: «una donna che se ne va è un affare di "
       "famiglia, non della legge.» Poi si allontana di tre passi e resta lì. In una sala senza "
       "spifferi le fiamme delle lampade stanno ferme; solo quella sopra il vostro tavolo si "
       "abbassa e risale, sempre alla stessa cadenza. Fra i fogli ingialliti tutti allo stesso "
       "modo, una piega è più netta delle altre.",
    4: "Di notte la Gendarmeria sa di stufa spenta da poco e di caffè d’orzo lasciato sul fondo "
       "del bricco; nell’ingresso fa più freddo che nella corte, e il fiato si vede. Un piantone "
       "solo dietro il bancone, il registro delle presenze aperto, una fila di chiodi con le "
       "sciabole appese, e la lavagna delle ronde dove i turni della notte sono già scritti col "
       "gesso — tutti tranne l’ultimo. Il brigadiere vi ascolta con le braccia conserte e non vi "
       "fa sedere; quando sente il nome si volta a guardare gli scaffali delle pratiche vecchie "
       "prima di rispondervi, e slaccia il primo bottone della giubba come chi si prepara a stare "
       "in piedi ancora un pezzo. «Tra noi: quel caso l’abbiamo chiuso troppo in fretta. Come "
       "tanti, ai tempi», dice, e intanto tiene un dito sul bordo del bancone e lo batte piano, "
       "sempre tre volte, poi si ferma, poi ricomincia. Sul bancone c’è una cassetta di cartoni "
       "d’archivio pronta da riportare di sotto: quello in cima è già slegato, e la polvere sul "
       "coperchio è stata tolta con la manica.",
    5: "Il deposito sa di calce spenta da poco — quell’odore che asciuga la bocca e lascia sulla "
       "lingua un sapore di gesso —, e ci fa più caldo di quanto un magazzino di notte possa "
       "spiegare. Sacchi accatastati a piramide contro la parete, secchi impilati a colonna, "
       "cazzuole e frattazzi appesi a un travetto in fila per misura, il pavimento battuto e "
       "bianco di polvere fino a mezzo stinco. Bortolo Sassi non vi fa entrare subito: prima passa "
       "dietro di voi a chiudere la porta, e ha le mani bianche fino al gomito e i polsi che "
       "tremano appena, così che la lanterna disegna sui sacchi un cerchio di luce che non sta "
       "fermo. «Io ho una famiglia, signori», dice, e lo ripete due volte con le stesse parole, "
       "come chi ha provato la frase venendo alla porta. Sul banco il libro mastro è aperto e "
       "tenuto fermo da una cazzuola; in un angolo, in piedi contro il muro, sta un rotolo di "
       "carta legato con lo spago. Nella polvere del pavimento le impronte vanno tutte in un verso "
       "solo, verso la porta sul retro, e sono fresche.",
    6: "L’aria che esce da dietro l’intonaco spaccato è più fredda della camera e non sa di "
       "cantina: sa di calce asciutta e di lino, un odore pulito, da armadio chiuso da molti anni. "
       "Il vano è stretto quanto un uomo di spalle, murato con mattoni posati a mano e in fretta, "
       "la malta strabordata e mai raschiata via; dentro non c’è ragnatela, non vola polvere, non "
       "c’è niente di ciò che il tempo lascia di solito — soltanto il pallore di quello che dieci "
       "anni di calce hanno tenuto fermo, e un lembo di stoffa che al tatto è ancora morbido. A "
       "posare la mano sulla parete il palmo la sente lavorare: un brusio minuto e continuo, come "
       "l’acqua in una conduttura, che si interrompe quando smettete di toccare e riprende quando "
       "toccate di nuovo. Le parole arrivano una alla volta, sempre le stesse, con la pazienza di "
       "chi detta a uno scrivano: «ferma di battere le mani, Ada». Sul davanzale, dalla parte del "
       "vano, qualcuno ha lasciato in piedi un piccolo ritratto in cornice d’ottone, girato verso "
       "il muro.",
    7: "Casa Malfanti sa di cera d’api e di stoffa nuova, e ci fa più caldo che nelle altre case "
       "della corte: la stufa è carica, i tendaggi doppi sono tirati, e l’aria ha quella "
       "pesantezza da salotto in cui non si apre mai la finestra. Il mobilio è buono e disposto a "
       "squadra — il tavolo col centrino inamidato, le sedie a distanze uguali, il pendolo che va "
       "—, e le pareti sono piene tranne una, dove la carta da parati è più scura in due "
       "rettangoli grandi come ritratti. Rosa vi fa accomodare prima ancora che Corrado si sia "
       "deciso ad alzarsi dalla poltrona; lui resta seduto un momento di troppo, poi viene avanti "
       "abbottonandosi la giacca da casa, e i suoi occhi vi contano — uno, due, tre — prima di "
       "guardarvi in faccia. «Andate a casa, signori: certe pareti è meglio non aprirle», dice, e "
       "mentre lo dice sorride a Rosa. Sul comò, su un centrino piegato apposta, sta ritta una "
       "fede da donna, lucidata di fresco, girata verso la porta.",
    8: "Sull’orlo del quartiere dei pozzi il magazzino della fornitura sa di pietra bagnata e di "
       "acqua di cisterna, e il freddo che ci sta dentro è quello dei sotterranei, non quello "
       "della notte. Sotto le tettoie i mucchi di sabbia stanno divisi per grana, ciascuno con la "
       "sua paletta piantata in cima come una bandiera; poi le cataste di pietra squadrata, i "
       "barili di calce con la data scritta a carbone sul fondo, e in mezzo una bilancia a bilico "
       "grande abbastanza per un carro. Il magazziniere vi riceve col grembiule ancora addosso e "
       "le unghie orlate di bianco; prima di rispondere passa la mano sul mucchio più fine e se la "
       "strofina sotto il naso, un gesto che ripete tre o quattro volte mentre parla: «roba fine, "
       "cara. La compra chi vuole muri che durano.» Nel silenzio, sotto le tettoie, la sabbia si "
       "assesta da sola con un fruscio lungo, e poco dopo ricomincia. Sul banco, fermata da un "
       "pesetto d’ottone, c’è una lettera aperta su carta troppo bella per un magazzino.",
    9: "Etere e collodio: la bottega del fotografo prende alla gola come una farmacia, e sotto "
       "l’odore chimico ce n’è uno più dolce, d’aceto e di vernice, che viene dallo stanzino rosso "
       "in fondo. Il fondale dipinto — un balcone con la balaustra e un cielo che non è di qui — "
       "pende dal soffitto arrotolato a metà; ai muri, in cornice nera, i ritratti dei clienti "
       "guardano tutti nella stessa direzione, e in mezzo alla fila c’è un chiodo senza niente "
       "sopra. Il fotografo lavora anche a quest’ora, coi mezzi guanti e la visiera verde, e non "
       "smette di lucidare il vetro che tiene in mano mentre vi ascolta: lo passa e ripassa nello "
       "stesso punto molto più a lungo di quanto un vetro richieda. «Un giorno si condanneranno "
       "gli assassini con le lastre, non con le chiacchiere», dice, e finalmente lo posa. Sul "
       "cavalletto la macchina grande è già girata verso la porta, col soffietto tirato, e la "
       "vaschetta del magnesio è carica.",
}
...
TESSERE_DESC_10 = {
    'T1': "Il tinello è la prima stanza e sa di minestra fredda e di calce: due odori che non "
          "stanno insieme, e il secondo vince. La cena è ancora in tavola per due, i piatti "
          "pieni, il pane spezzato e non mangiato; una sedia è rovesciata all’indietro, l’altra "
          "scostata di traverso, e il lume a olio lasciato acceso ha finito lo stoppino buono e "
          "fuma una riga nera dritta fino al soffitto, dove ha già segnato un cerchio. Alle "
          "pareti l’intonaco è nuovo e chiaro fino all’altezza di un uomo, poi torna vecchio: il "
          "restauro si è fermato lì, come chi smette di raccontare a metà. Dall’alto arriva un "
          "tonfo sordo, poi il silenzio, poi un altro tonfo — sempre lo stesso intervallo, come "
          "un cuore lento —, e a ogni colpo dalle travi scende un velo di polvere che si vede "
          "solo contro il lume. Fra un tonfo e l’altro, dalla parete alla vostra destra, esce un "
          "sussurro alla misura di un respiro, e non smette. Sul tavolo, accanto al piatto "
          "pieno, un bicchiere è rimasto in piedi, e il vino dentro trema.",
    'T2': "La scala è stretta e ripida come una scala di barca, e salendo l’aria cambia: al "
          "pianerottolo sa ancora di cena, tre gradini più su solo di calce e di legno nuovo. Il "
          "corrimano è liscio, consumato al centro da mani che non abitano più qui; i gradini "
          "invece sono stati rifatti, tavole chiare inchiodate sopra un’ossatura vecchia che si "
          "sente lavorare sotto il piede. A ogni gradino i muri rendono un pezzo di una notte di "
          "dieci anni fa, e non è un’eco: è una voce d’uomo che sale, dura, e sotto, più bassa, "
          "una voce di donna che prega — sempre allo stesso punto della scala, sempre le stesse "
          "due battute, come un solco che ricomincia da capo. Chi sale per secondo le sente un "
          "gradino più tardi di chi sale per primo. Il terzo gradino, se lo guardate, è di un "
          "legno diverso — più scuro, più molle. Sul muro, all’altezza della mano, l’intonaco "
          "nuovo porta cinque ditate parallele, di chi si è tenuto scendendo in fretta.",
    'T3': "Il corridoio è più lungo di quanto la facciata della casa lasci credere, ed è cieco: "
          "porte chiuse a destra e a sinistra, nessuna finestra, e in fondo il buio che la "
          "lanterna non arriva a toccare. Qui l’odore di calce si assottiglia e resta quello "
          "della casa vecchia sotto — cera, panni, cenere di camino spento. Le porte hanno tutte "
          "la stessa maniglia di porcellana, e tutte hanno sotto la maniglia lo stesso alone di "
          "dita, tranne una, socchiusa di un palmo. Dai muri escono i nomi degli inquilini a "
          "mezza voce, senza fretta, come chi conta per addormentarsi: nomi di vecchi, nomi di "
          "bambini, nomi di sposi, sillabati piano e posati uno dopo l’altro. Uno torna più "
          "spesso degli altri, e torna con un’altra tenerezza: «A-da». Fra i nomi, a restare "
          "fermi ad ascoltare, ne passa uno che si conosce meglio degli altri. La riga di "
          "polvere lungo il battiscopa è intatta per tutto il corridoio, tranne davanti alla "
          "porta socchiusa, dove qualcosa l’ha spazzata via trascinandosi.",
    'T4': "La camera è la stanza più fredda della casa, e il freddo viene da una parete sola: "
          "quella cieca verso la corte, che si sente prima di toccarla, passandoci la mano "
          "davanti. Il letto dei Neri è disfatto e le coperte sono buttate da un lato solo, come "
          "si esce quando si esce di colpo; la finestra è sbarrata dall’interno con una tavola "
          "inchiodata di fresco, e sul soffitto un trave scalzato dai lavori appoggia storto, "
          "con accanto una crepa che lascia cadere un filo di calcina, un poco per volta. La "
          "parete cieca suda: gocce bianche, spesse, che scendono lente e si fermano a metà. E "
          "la voce, qui, non sussurra più: detta. Fa le pause al posto giusto, ripete l’ultima "
          "parola quando la pausa è stata troppo lunga, e ricomincia da capo appena finita. In "
          "un angolo, dove la lanterna non era ancora arrivata, c’è un uomo accovacciato in "
          "cappotto buono, le mani avanti, il cappello a terra accanto a lui: non ha fatto "
          "rumore per tutto il tempo in cui parlavate.",
    'T5': "Sotto la scala il passaggio si stringe fino a costringervi di fianco, e i mattoni "
          "sudano: umidità vera, da cantina, con la muffa che disegna sul muro macchie a forma "
          "di continente. L’odore di calcina bagnata taglia il naso; a terra i calcinacci sono "
          "ammucchiati contro la parete in cumuli ancora umidi, e ci si cammina sopra con un "
          "crocchio di ghiaia che nel resto della casa non c’è. Sui gradini di pietra che "
          "scendono alla cantina qualcuno ha steso dei sacchi vuoti, uno dopo l’altro, per non "
          "far rumore. Dal fondo, dove il budello svolta, arriva aria che si muove: la porta sul "
          "retro è socchiusa e ogni tanto batte contro il fermo, piano, sempre due colpi. Due "
          "ragazzi in grembiule da manovale stanno sull’ultimo gradino e vi sbarrano il passo "
          "tenendosi vicini, le mani bianche di calce, e non dicono niente perché nessuno ha "
          "detto loro cosa dire. Contro il muro gli attrezzi stanno appoggiati in fila, tutti "
          "uguali e tutti bianchi; in mezzo alla fila resta un vuoto largo quanto un manico.",
    'T6': "La stanza è piena di polvere di calce sospesa, che la lanterna trasforma in un muro "
          "di luce; si respira col fazzoletto sulla bocca, e quel che resta in gola sa di gesso "
          "e di moneta. Della parete doppia sta in piedi meno di metà: l’intonaco è giù a "
          "chiazze grandi come lenzuola, i mattoni sono stati sfilati a uno a uno e accatastati "
          "di fianco con l’ordine di chi lavora bene anche quando lavora male. Dal varco viene "
          "aria ferma e fredda, e nel varco c’è il pallore di ciò che dieci anni di calce hanno "
          "tenuto: una forma che il buio restituisce a pezzi, e che nessuno di voi guarda per "
          "intero tutta insieme. Sopra, enorme nella luce della lanterna, il Muratore alza di "
          "nuovo la mazza, e la polvere si apre attorno al ferro e si richiude. Fra un colpo e "
          "l’altro la voce nel muro continua, più piena adesso che il muro è aperto, e riprende "
          "sempre dalla stessa parola. A terra, in mezzo ai calcinacci, un mattone è rimasto "
          "intero, con la malta ancora attaccata su tre lati.",
}
