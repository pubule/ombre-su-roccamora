...
def soluzione():
    ...
    pagina('soluzione — non aprire', [
        ...
        'A M. DELLA TALPA</b> — i membri della Società restano uniti per tutto l’Atto III, ma la sua '
        ...
        'lo scisma dell’Episodio 17 costerà un alleato in più. Alla riga «Episodio 18» del Taccuino '
