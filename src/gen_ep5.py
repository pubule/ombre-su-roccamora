...
LETTERA_5 = (
    ...
    "<font name=\"OldStd-Italic\"><i>Luoghi disponibili dall’inizio: la chiesa dei Battuti, l’ossario comunale, il "
    ...
    "21:00: le lapidi che portano via, dopo, non le trovate più.</i></font>")
