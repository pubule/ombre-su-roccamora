...
BIO_SCHEDA = {
    ...
    'DOTT. ATTILIO MARN':
        ...
        "bene; vent\u2019anni dopo sa che la città uccide più della malaria, e che nessun "
        "titolo dell\u2019Accademia insegna a riconoscere l\u2019odore della paura in una stanza. "
        "Cura chiunque bussi, all\u2019ora che sia, senza chiedere come si è procurato la "
        ...
        "solo lui rilegge. Nella borsa, tra garze e sali, tiene un bisturi più lungo "
        "del necessario. Non lo ha mai usato su un vivo. Se lo porta comunque.",
    'SIBILLA REVE':
        "Legge le carte alle vedove per denaro, ed è vero \u2014 ma è anche il modo "
        "migliore per farsi raccontare una città intera senza mai fare una domanda: "
        "chi ha paura parla, e a lei parlano tutti. Sa distinguere la superstizione "
        "dal pericolo autentico perché il secondo l\u2019ha guardata in faccia una notte, "
        "da bambina, sul bordo di un pozzo dove qualcosa la chiamava per nome con la "
        "voce di sua madre morta. Non si è sporta. Da allora il confine tra i due "
        "mondi, per lei, è una linea sottile e reale come il filo di un rasoio. Il "
        "pendolo d\u2019ossidiana che porta al collo era di sua nonna, che glielo mise in "
        "mano dicendo \u201cnon è mai stato fermo, e non fidarti di quando lo è\u201d. Non lo "
        "è mai stato. Sibilla ha imparato a non fidarsi.",
    'NINO \u201cGRIMALDELLO\u201d CAUTO':
        "Cresciuto sui tetti, nelle intercapedini e nei sottotetti di Roccamora, "
        "conosce la città come un ladro conosce le tasche altrui: al buio, per tatto, "
        "senza bisogno di guardare. Da ragazzino entrava nelle case dei ricchi per "
        "rubare il pane; da uomo è entrato una volta di troppo nel posto sbagliato, e "
        ...
        "parla troppo, e tiene sempre un occhio sull\u2019uscita più vicina \u2014 un\u2019abitudine "
        "che gli ha salvato la pelle più volte delle sue mani veloci. Le serrature, "
    ...
    'OTTONE \u201cMEZZENA\u201d MASSARI':
        ...
        "smette di mangiare e di ridere, lì sotto c\u2019e\u2019 il male. Alla festa, quest\u2019anno, "
    ...
    'FULGENZIO CARBONE':
        ...
        "disfarsene in fretta. Fulgenzio compra ciò che le famiglie di Roccamora vogliono "
        "far sparire \u2014 reliquie di santi mai canonizzati, diari con le pagine cucite, "
        "specchi che le domestiche si rifiutano di pulire \u2014 e paga bene, purché gli si "
        "dica la verità sulla provenienza. Non rivende quasi mai: il retrobottega è un "
    ...
    'OTTAVIO BRERA':
        ...
        "\u201csuggestione\u201d perché era l\u2019anno della promozione. In pensione da tre anni, ha "
        "smesso di dormire bene e ha cominciato a rimediare: riapre fascicoli che nessuno "
        "reclama, paga di tasca sua le perizie che il tribunale negò, e cammina per la "
        "città senza scorta perché la malavita, quella vera, il giudice Brera lo saluta "
        "ancora togliendosi il cappello \u2014 metà per rispetto, metà per paura. Sa che il "
        "culto compra i bravacci a giornata. E sa che nessuno di loro morirà per una "
        "causa che non paga il sabato.",
    'MORA \u201cSPILLA\u201d FANTI':
        "A Roccamora la chiamano \u201cSpilla\u201d perché dicono che con un sandolo infila "
        "qualunque canale, anche quelli che sulle mappe non ci sono più. Di giorno "
        ...
        "che doveva sparire da una città e comparire in un\u2019altra. Ha imparato a leggere "
        "l\u2019acqua prima di leggere le lettere, e i capelli cortissimi se li è tagliata "
