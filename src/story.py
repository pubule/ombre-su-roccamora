...
LETTERA2 = (
    ...
    "chi fugge, per\u00f2, non lascia la lanterna appesa al gancio. "
...
BIO_SCHEDA = {
    'ELENA FOSCO':
        ...
        "troppo. Ha imparato da entrambi la stessa cosa: che la verità è una "
        "questione di tempo e di orecchio. Lasciò la polizia la notte in cui un "
        "commissario le mise una mano sulla spalla e le disse, paterno, di lasciar "
        "perdere il \u201ccaso del pozzo\u201d \u2014 e lei capì dal peso di quella mano che "
    ...
    'DOTT. ATTILIO MARN':
        "Ha aperto l\u2019ambulatorio nei vicoli bassi da giovane, con l\u2019idea di fare "
        "del bene; vent\u2019anni dopo sa che la città uccide più della malaria, e che nessun "
        "titolo dell\u2019Accademia insegna a riconoscere l\u2019odore della paura in una "
        "stanza. Cura chiunque bussi, all\u2019ora che sia, senza chiedere come si è "
        "procurato la ferita — ed è per questo che è l\u2019unico in città a vedere questi "
        "corpi prima che diventino un verbale: i portuali, le vedove, quelli che alla "
        "Gendarmeria non risultano nemmeno. Le cose che i colleghi archivierebbero come "
        "delirio ha smesso di raccontarle e ha cominciato ad annotarle, in una grafia minuta "
        "che rilegge solo lui: pupille che non reagiscono alla luce, morti troppo composti. È "
        "il quaderno di quest\u2019inverno a non dargli pace — tre pazienti diversi in tre "
        "giorni, la stessa cera nera sotto le unghie, e tutti e tre a giurare di non aver mai "
        "toccato una candela. Nella borsa, tra garze e sali, tiene un bisturi più lungo del "
        "necessario. Non lo ha mai usato su un vivo. Se lo porta comunque.",
    'SIBILLA REVE':
        "Legge le carte alle vedove per denaro, ed è vero — ma è anche il modo migliore per "
        "farsi raccontare una città intera senza mai fare una domanda: chi ha paura parla, e "
        "a lei parlano tutti. Sa cosa Roccamora teme mesi prima che qualcuno lo denunci, e sa "
        "distinguere la superstizione dal pericolo autentico perché il secondo l\u2019ha "
        "guardata in faccia una notte, da bambina, sul bordo di un pozzo dove qualcosa la "
        "chiamava per nome con la voce di sua madre morta. Non si è sporta. Da allora il "
        "confine tra i due mondi, per lei, è una linea sottile e reale come il filo di un "
        "rasoio. Il pendolo d\u2019ossidiana che porta al collo era di sua nonna, che glielo "
        "mise in mano dicendo \u201cnon è mai stato fermo, e non fidarti di quando lo "
        "è\u201d. Da settembre le vedove del Borgo hanno smesso di chiederle il futuro: le "
        "chiedono tutte la stessa cosa, se una voce sentita in casa possa essere di qualcuno "
        "che è morto. E il pendolo, da settembre, gira più stretto.",
    'NINO \u201cGRIMALDELLO\u201d CAUTO':
        "Cresciuto sui tetti, nelle intercapedini e nei sottotetti di Roccamora, conosce la "
        "città come un ladro conosce le tasche altrui: al buio, per tatto, senza bisogno di "
        "guardare. Da ragazzino entrava nelle case dei ricchi per rubare il pane; da uomo è "
        "entrato una volta di troppo nel posto sbagliato, e quel lavoro finito male gli ha "
        "lasciato addosso un debito con gente che non dimentica e una ragione, per ora, di "
        "stare dalla parte giusta. Ride facile, parla troppo, e tiene sempre un occhio "
        "sull\u2019uscita più vicina — un\u2019abitudine che gli ha salvato la pelle più "
        "volte delle sue mani veloci. Le serrature, dice, sono domande poste male: basta "
        "capire cosa vogliono sentirsi chiedere. L\u2019ultimo lavoro gliel\u2019ha "
        "commissionato uno che pagava troppo per una porta troppo semplice, e che gli ha "
        "raccomandato di non guardare dentro. Ha guardato. Da allora dorme con la lampada "
        "accesa, e quando gli chiedono che cosa ha visto cambia discorso in fretta.",
    'OTTONE \u201cMEZZENA\u201d MASSARI':
        ...
        "vino e di risate, è l\u2019uomo con cui tutti si confidano perché nessuno lo "
        "teme \u2014 a torto: dietro il grembiule insanguinato del macellaio c\u2019è una mente "
        "che non dimentica un volto. Ha cominciato a farsi domande quando il suo "
        "garzone sparì durante la festa di San Teodoro e tornò tre giorni dopo senza "
        "appetito e senza voce, con lo sguardo di chi ha lasciato qualcosa di sé da "
        "qualche parte, al buio. Dice che una città si legge a tavola: dove la gente "
        "smette di mangiare e di ridere, lì sotto c\u2019è il male. Alla festa, quest\u2019anno, "
        "non è andato nessuno.",
    'CARLA DOSTI':
        "Prima donna in redazione al Corriere di Roccamora, la misero ai necrologi per "
        "toglierla di mezzo \u2014 e fu il loro errore: Carla scoprì che i necrologi, letti "
        ...
        "sé, una memoria feroce che non perdona né le bugie né chi le dice, e la "
        "convinzione ostinata \u2014 pericolosa, in questa città \u2014 che la verità sia un "
        "diritto di tutti, anche quando è indicibile, anche quando conviene a molti "
        "che resti sepolta. Ha già ricevuto il primo avvertimento. Lo ha fotografato.",
    'DOTT. LAZZARO SERRA':
        "Il manicomio di Roccamora sta su un\u2019isola che le mappe della città preferiscono "
        ...
        "lui li lascia fare, perché sa una cosa che loro non sanno: i suoi pazienti non "
        ...
        "e i quaderni, ormai, sono più di trenta. Quando tre internati che non si erano "
    ...
    'PADRE CELSO MARANI':
        "Il verbale dell\u2019esorcismo di Ca\u2019 Landi, ottobre 1884, è chiuso in un cassetto "
        "della Curia con la sua firma in calce: è per quello che l\u2019hanno sospeso, non "
        "per il rito. Perché Padre Celso non scrisse \u201cisteria\u201d come volevano, né "
        ...
        "fanno domande, e continua il mestiere senza più chiedere permesso a nessuno: "
        ...
        "farsi trovare \u2014 dal silenzio, dice, che non è mai dello stesso tipo. Ha paura "
        "di una cosa sola: che la Curia avesse ragione a fermarlo, e che certe porte, una "
        "volta aperte, non lo lascino più tornare indietro.",
    'FULGENZIO CARBONE':
        ...
        "disfarsene in fretta. È l\u2019imbuto dove finisce tutto ciò che le famiglie di "
        "Roccamora vogliono far sparire — reliquie di santi mai canonizzati, diari con le "
        "pagine cucite, specchi che le domestiche si rifiutano di pulire — e lui paga bene, "
        "purché gli si dica la verità sulla provenienza. Non rivende quasi mai: il "
        "retrobottega è un archivio di cose che non stanno ferme di notte, catalogate con "
        "calligrafia minuta e maniacale. Sostiene che ogni oggetto ricordi le mani che "
        "l\u2019hanno toccato, e che basti saperlo interrogare. Da qualche mese, però, il "
        "registro racconta una cosa che non gli piace: pezzi che aveva già comprato una volta "
        "tornano da lui, rivenduti da mani diverse: qualcuno sta ricomprando la città un "
        "oggetto per volta, e paga meglio di lui. Sa di collezionare esche. Spera solo di non "
        "essere lui, alla fine, il pesce.",
    'OTTAVIO BRERA':
        "Trent\u2019anni di sentenze nel tribunale di Roccamora lasciano due cose: la memoria "
        "dei volti — tutti, imputati, testimoni, bugiardi — e un elenco di rimorsi rilegato "
        "meglio di qualunque codice. In cima all\u2019elenco di Ottavio Brera c\u2019è il "
        "caso del pozzo, archiviato nel 1876 con una firma che era la sua: la bambina diceva "
        "che qualcosa l\u2019aveva chiamata per nome dall\u2019acqua, e lui scrisse "
        "\u201csuggestione\u201d perché era l\u2019anno della promozione. In pensione da tre "
        "anni, ha smesso di dormire bene e ha cominciato a rimediare: riapre fascicoli che "
        "nessuno reclama, paga di tasca sua le perizie che il tribunale negò, e cammina per "
        "la città senza scorta perché la malavita, quella vera, il giudice Brera lo saluta "
        "ancora togliendosi il cappello — metà per rispetto, metà per paura. Proprio per "
        "questo se n\u2019è accorto prima degli altri: da un anno i bravacci di Roccamora "
        "lavorano per qualcuno che paga puntuale il sabato, e nessuno di loro sa dire per "
        "chi.",
    'MORA \u201cSPILLA\u201d FANTI':
        "A Roccamora la chiamano \u201cSpilla\u201d perché dicono che con un sandolo infili "
        "qualunque canale, anche quelli che sulle mappe non ci sono più: conosce ogni "
        "sporgenza, ogni cancello rotto, ogni guardia corruttibile tra la Banchina e "
        "l\u2019Archivio. Di giorno trasporta legname e sale; di notte, quello che paga "
        "meglio — tabacco di contrabbando, lettere che non devono passare per la posta, una "
        "volta un uomo che doveva sparire da una città e comparire in un\u2019altra. Ha "
        "imparato a leggere l\u2019acqua prima di leggere le lettere, e i capelli cortissimi "
        "se li è tagliati lei stessa, a coltello, il primo inverno che ha dovuto passare per "
        "un ragazzo alla dogana. Ombra, il furetto che le dorme in tasca, viene da un carico "
        "mai consegnato: doveva finire su un tavolo di dissezione, e Mora ha deciso che "
        "quella notte il fiume avrebbe reso un favore a qualcuno per una volta. "
        "Quest\u2019inverno tre delle sue rotte si sono chiuse in una notte sola: cancelli "
        "nuovi dove non c\u2019era niente da chiudere, e chiatte senza lanterne che passano "
        "dove passava lei.",
}
