...
// tipo: stessa idea del `tipo` degli Approfondimenti (LUOGHI), formalizza le
// famiglie gia' informalmente raggruppate qui sotto - diventa anche la riga
// "Tipo" stampata sulla carta (come Eroe/Nemico), cosi' si vede a tavolo chi
// e' una Trappola senza dover controllare il regolamento. 'inquietudine' e
// non 'presagio' per la carta PRESAGIO apposta: 'Presagio' e' gia' un tipo
// di Approfondimento nei Luoghi - stesso nome per due cose diverse
// confonderebbe al tavolo.
const MINACCE = [
  { art: 'artworks/Adepto Incappucciato.png', title: 'Adepto in Agguato', tipo: 'Adepto',
  ...
  { art: 'artworks/Volti tra le casse.png', title: 'Volti tra le Casse', tipo: 'Adepto',
  ...
  { art: 'artworks/Il falcetto nel buio.png', title: 'Il Falcetto nel Buio', tipo: 'Adepto',
  ...
  { art: 'artworks/La Vedetta.png', title: 'La Vedetta', tipo: 'Adepto',
  ...
  { art: 'artworks/Cani dei Moli.png', title: 'Cani dei Moli', tipo: 'Cane',
  ...
  { art: 'artworks/Unghie sulla pietra.png', title: 'Unghie sulla Pietra', tipo: 'Cane',
  ...
  { art: 'artworks/Il Fonditore.png', title: 'Il Fonditore', tipo: 'Fonditore',
  ...
  { art: 'artworks/La marea di cera.png', title: 'La Marea di Cera', tipo: 'Fonditore',
  ...
  { art: 'artworks/Ronda.png', title: 'Ronda', tipo: 'Adepto',
  ...
  { art: 'artworks/Lama nel Buio.png', title: 'Lama nel Buio', tipo: 'Malavita',
  ...
  { art: 'artworks/Trappola di cera.png', title: 'Trappola di Cera', tipo: 'Trappola',
  ...
  { art: 'artworks/Cera sotto i piedi.png', title: 'Cera sotto i Piedi', tipo: 'Trappola',
  ...
  { art: 'artworks/Fumi soporiferi.png', title: 'Fumi Soporiferi', tipo: 'Trappola',
  ...
  { art: 'artworks/Il canto sale.png', title: 'Il Canto Sale', tipo: 'Canto',
  ...
  { art: 'artworks/Il coro risponde.png', title: 'Il Coro Risponde', tipo: 'Canto',
    flavor: 'Dieci voci. Poi cento. La pietra le beve tutte.',
    effect: 'Aggiungete 1 segnalino Canto. Al terzo: il Custode della Cera si desta. Se è già in gioco: recupera 1 ferita e si attiva subito.' },
  { art: 'artworks/Il canto cresce.png', title: 'Il Canto Cresce', tipo: 'Canto',
    flavor: 'Le voci salgono di un tono. Sotto i piedi, la pietra vibra.',
    effect: 'Aggiungete 1 segnalino Canto. Al terzo: il Custode della Cera si desta. Se è già in gioco: recupera 1 ferita e si attiva subito.' },
  { art: 'artworks/Presagio.png', title: 'Presagio', tipo: 'Inquietudine',
    flavor: 'Una candela si spegne da sola. Nessuno ha fiatato.',
    effect: 'Un brivido corre lungo la schiena. Non accade nulla... per ora.' },
  { art: 'artworks/Eco amica.png', title: 'Eco Amica', tipo: 'Evento',
  ...
  { art: 'artworks/Cera che cola.png', title: 'Cera che Cola', tipo: 'Ambientale',
  ...
  { art: 'artworks/Rinforzi dal canale.png', title: 'Corrente Gelida', tipo: 'Ambientale',
  ...
  { art: 'artworks/Sussurri.png', title: 'Sussurri', tipo: 'Ambientale',
