...
const EP17_MINACCE = [
  ...
  { art: 'artworks/Rasca dà l’ordine.png', title: 'Rasca dà l’Ordine', tipo: 'Crescendo',
    ...
    effect: 'Aggiungete 1 segnalino Canto (il Trasferimento). Alla soglia-decano (Canto 3, 4 col Salvacondotto): il decano è trasferito — vedi Soluzione. Alla soglia-Canto (3): +1 carta Minaccia per Fase, per sempre.' },
...
const EP18_MINACCE = [
  ...
  { art: 'artworks/Fischietti nel cortile.png', title: 'Fischietti nel Cortile', tipo: 'Crescendo',
    ...
    effect: 'Aggiungete 1 segnalino Canto (la Rete). Alla soglia-arresto (Canto 4, 5 con l’Uscita di Servizio): i gendarmi sigillano — vedi Soluzione. Alla soglia-Canto (3): +1 carta Minaccia per Fase, per sempre.' },
...
const EP20_OGGETTI = [
  { art: 'artworks/Frammenti del Controcanto.png', nome: 'I Frammenti del Controcanto', ref: 'E20-L4',
    ...
    effetto: 'La deduzione finale. Servono 10 righe di controcanto. Nella camera (T6), il controcanto avanza di 1 riga + 1 ogni 6 Frammenti conservati per round: più ne avete, più cantate giusto.' },
