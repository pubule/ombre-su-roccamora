  ...
  { n: 6, nome: 'Lo Scriptorium',
    ...
    approfondimenti: [
      { tipo: 'Referto', soggetto: 'La mano che non imita',
        testo: 'La mano della copia non IMITA quella dei Frammenti: è quella mano. Sicura, senza le micro-esitazioni di chi ricalca un modello. O il falsario è il più grande mai visto — capace di scrivere la mano altrui con più naturalezza del proprietario — o non c’è falsario, e qualcuno adopera la penna del presidente perché ne ha l’uso. Il registro non aiuta a scegliere: gli ordini sono veri, e protocollati in ore in cui il presidente sedeva in assemblea, a verbale.' },
    ] },
  ...
  { n: 1, nome: 'La Stazione delle Carrozze', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'Il capostazione',
        testo: '«Quel nolo puntuale lo intesta sempre lo stesso studio, quello del Notaio Rasca. Carta in regola, paga prima. E il capo-catena, buon’anima, aveva cominciato a cronometrarlo come si cronometra un treno: l’ora di partenza, le soste, il ritorno. Segnava tutto su un taccuino, e certe notti una fermata in più al Palazzo del Lume. Poi è annegato.»' },
    ] },
  { n: 2, nome: 'Lo Studio del Notaio', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Referto', soggetto: 'La cortesia del Notaio',
        testo: 'Rasca non commette errori: ogni carta in regola, ogni bollo a posto, ogni pagamento puntuale. È la perfezione a tradirlo — nessun cliente onesto è così invisibile. È l’uomo del «benefattore che ama la lirica», e non la prima maschera di carta della specie: «La Quiete S.A.» del quartiere sordo, senza dipendenti, aveva sede presso uno studio notarile. Sapere chi tiene la penna del nolo è metà della caccia.' },
    ] },
  { n: 3, nome: 'L’Ufficio del Fermo-Posta', req: 'Disponibile dall’inizio',
    art: 'artworks/L’Ufficio del Fermo-Posta.png',
  ...
  { n: 4, nome: 'La Dogana Vecchia', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'Il doganiere',
        testo: '«Ve lo metto a verbale perché ormai è morto lui e non io: il capo-catena aveva preso a contare il nolo della carta ora per ora, notte per notte. Sapeva a memoria quando parte e quando torna. Diceva anche che nelle notti giuste fa una fermata in più, certe notti, al Palazzo del Lume — che cosa ci vada a fare non me l’ha spiegato, e io non gliel’ho chiesto. È annegato per quello che aveva contato.»' },
    ] },
  { n: 5, nome: 'La Casa del Capo-Catena',
    ...
    approfondimenti: [
      { tipo: 'Presagio', soggetto: 'La deposizione mai resa',
        testo: 'A leggere i suoi fogli nell’ordine giusto, la voce del capo-catena torna come da sotto l’acqua: il calco di una testimonianza che nessuno ha raccolto in tempo. Vi dice tre cose — a che ora parte il nolo della carta; a che ora, stanotte, daranno fuoco ai registri; e per dove passa la guardia. Una quarta l’ha segnata e non l’ha sciolta: quella fermata in più. È tutto quello che sarebbe morto in tribunale. Fatelo arrivare voi.' },
    ] },
  ...
  { n: 5, nome: 'L’Archivio dei Manuali',
    ...
    approfondimenti: [
      { tipo: 'Presagio', soggetto: 'La copia consultata',
        testo: 'Dodici copie, tutte presenti, tutte censite. La n. 7 ha il dorso allentato e si apre da sé al capitolo sulla grafia, l’unico con le cocche piegate. Sul registro delle consultazioni, alla riga del mese scorso, la firma è stata raschiata via: resta il solco della penna e il pelo della carta sollevato. Nessuno ha forzato quello scaffale, e nessuno ha portato via niente.' },
    ] },
  { n: 6, nome: 'Lo Studio del Perito',
...
const LUOGHI16 = [
  { n: 1, nome: 'La Casa del Lampionaio', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'Il lampionaio',
        testo: '«Il nastro verde al polso di Nina era un segreto tra me e lei, un pegno di compleanno, mai detto ad anima viva. Eppure il signore della vostra Società lo sapeva, ieri, prima ancora che voi arrivaste. Chiedetevi come fa un uomo a sapere un segreto che nessuno gli ha detto. Io, la notte, non dormo più a pensarci.»' },
    ] },
  ...
  { n: 4, nome: 'La Stazione delle Carrozze', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'Il capostazione',
        testo: '«La ragazza me la ricordo bene, ma non per la faccia: rideva come chi non ha mai preso una vettura per andare lontano. Le facce non le tengo a mente, signori, tengo a mente gli orari. La carrozza per il lago era quella di sempre, la villa dei Càrpine sulla sponda di ponente, un’ora scarsa da qui. Non a nozze: a marcire finché lui non ha in mano la dote.»' },
    ] },
  { n: 5, nome: 'La Casa dell’Ex Fidanzata',
    ...
    approfondimenti: [
      { tipo: 'Presagio', soggetto: 'Il male con una misura',
        testo: 'Nella casa di questa donna il male ha una faccia piccola e un nome — anzi dieci nomi, tutti falsi. Dopo mesi di ombre senza volto, fa quasi tenerezza un cattivo così: prevedibile, meschino, umano. Un male con una misura si prende in una sera, e stasera basterà. Eppure, scendendo quelle scale, vi resta addosso il freddo di una cosa piccola che non torna — e non riguarda quest’uomo.' },
    ] },
  ...
  { n: 7, nome: 'Il Fioraio',
    ...
    approfondimenti: [
      { tipo: 'Osservazione', soggetto: 'Le rose dell’inganno',
        testo: 'Le rose bianche sono lo strumento del mestiere: fanno credere all’amore chi ha voglia di crederci. Il fioraio è l’unico che ha visto lo Sposo da vicino, ma non serve a nulla — dieci nomi, dieci facce. La pista dei fiori porta solo alla villa, che già conoscete. È un vicolo cieco profumato. Serve però a misurare l’uomo: paga in contanti, ordina sempre lo stesso mazzo, non lascia mai un indirizzo.' },
    ] },
  ...
  { n: 3, nome: 'Il Tribunale', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      ...
      { tipo: 'Testimonianza', soggetto: 'Il sacrestano del Tribunale',
        testo: '«Le porte del Tribunale le apro io alle cinque e le chiudo a mezzanotte: mi si guarda come si guarda un cardine. Il signore in guanti chiari viene di notte e non chiede mai dov’è una stanza; la carrozza chiusa lo aspetta nel cortile di dietro, col fanale spento. La notte in cui il decano sparì è passata di lì poco dopo le due, carica; prima dell’alba è tornata leggera. E a casa del decano non hanno forzato niente: chi è entrato aveva la chiave. Io a voi devo la vita.»' },
    ] },
