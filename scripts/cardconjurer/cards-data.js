...
const LUOGHI = [
  ...
  { n: 4, nome: 'La Sacrestia della Cattedrale', req: 'Don Callisto socchiude appena la porta e non fa entrare nessuno: si fida solo di chi gli porta notizie del suo sagrestano — quello di cui, in città, tutti fanno il nome.',
...
const OGGETTI = [
  ...
  { art: 'artworks/Diapason.png', nome: 'Il Diapason d’Argento', ref: 'L5', fonte: 'Luogo 5 — Bottega del Liutaio Ferri',
    ...
    effetto: 'In spedizione: un’azione adiacente al Custode della Cera lo fa vibrare — Difesa da 9 a 5 per il resto della partita, e il Custode salta la sua prossima attivazione.' },
...
const PRELUDIO_OGGETTI = [
  { art: 'artworks/Anello di Chiavi.png', title: 'L’Anello di Chiavi',
    ...
    rules: '{i}Vent’anni di tasca l’hanno lucidato più di qualunque argentiere.{/i}{divider}Nella spedizione: apre la porta della banchina (da T1 a T2) con Interagire, senza prove.' },
...
const EP2_OGGETTI = [
  { art: 'artworks/Martello di Collaudo.png', nome: 'Il Martello di Collaudo', ref: 'E2-L1',
    ...
    effetto: 'Da solo: nessun effetto. Insieme allo SMORZO DI FELTRO, un’azione adiacente allo Scoriatore: il colpo smorzato lo stona — Difesa da 8 a 5 per il resto della partita, e salta la sua prossima attivazione.' },
  { art: 'artworks/Smorzo di Feltro.png', nome: 'Lo Smorzo di Feltro', ref: 'E2-L2',
    ...
    effetto: 'Da solo: nessun effetto. Insieme al MARTELLO DI COLLAUDO, un’azione adiacente allo Scoriatore: il colpo smorzato lo stona — Difesa da 8 a 5 per il resto della partita, e salta la sua prossima attivazione.' },
...
const LUOGHI3 = [
  ...
  { n: 2, nome: 'La Bottega del Barbiere', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      ...
      { tipo: 'Testimonianza', soggetto: 'Silvano, su Piero',
        testo: 'Quando parlate di Piero, la cortesia si incrina. Dal collo tira fuori un campanellino d’argento, consumato: «lo suonavo io, piano, quando aveva le febbri. Tenetelo voi, per la processione di San Rocco — a me, ormai, canta troppo.»' },
    ] },
  ...
  { n: 4, nome: 'La Casa di Tobia — Corte dei Pozzaioli', req: 'Disponibile dall’inizio',
  ...
  { n: 6, nome: 'La Bottega del Lattoniere Zanchetta',
    req: 'Zanchetta salda e non ascolta: mezzo Borgo gli deve grondaie. Alza la testa solo per i clienti che sanno di che lavoro si parla — e voi, per ora, non lo sapete.',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'Zanchetta, sul committente',
...
const EP3_OGGETTI = [
  ...
  { art: 'artworks/Tappi di Cera.png', nome: 'I Tappi di Tobia', ref: 'E3-L4',
  ...
  { art: 'artworks/La Canna Muta.png', nome: 'La Canna Muta', ref: 'E3-L6',
    fonte: 'Luogo 6 — La Bottega del Lattoniere Zanchetta',
  ...
  { art: 'artworks/Campanello di Piero.png', nome: 'Il Campanello di Piero', ref: 'E3-L2',
    ...
    effetto: 'Un’azione adiacente all’Accordatore: suonarlo — la voce vera, non quella rubata. Difesa da 8 a 5 per il resto della partita, e salta la sua prossima attivazione.' },
...
const EP4_OGGETTI = [
  ...
  { art: 'artworks/Libretto di Gaspare.png', nome: 'Il Libretto di Gaspare', ref: 'E4-L7',
    ...
    effetto: 'Un’azione adiacente al Suggeritore: l’eco riconosce la voce vera del suo posto — Difesa da 8 a 5 per il resto della partita, e salta la sua prossima attivazione.' },
  ...
  { n: 1, nome: 'La Chiesa dei Battuti', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Osservazione', soggetto: 'Le mani del becchino',
        testo: 'Al funerale lampo di Fedele, il becchino-capo del cimitero nuovo lavora di pala con le maniche lunghe, d’estate. Quando le rimbocca per un attimo, i polsi sono segnati di bianco: non calce da fossa — polvere d’ossa. Un becchino la conosce. E la lava, di solito.' },
      { tipo: 'Presagio', soggetto: 'La salmodia sotto',
        testo: 'Con l’orecchio alla breccia rimurata: un canto piano, senza parole, che non si ferma MAI — e si vede un corridoio di nicchie dove le ossa nei muri rispondono al canto, una per una, come un registro che si accorda. Chi passerà di lì, tacendo e in fretta, passerà meglio. La visione dura un rintocco.' },
    ] },
  ...
  { n: 4, nome: 'La Parrocchia del Borgo', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Presagio', soggetto: 'Il fonte che trattiene',
        testo: 'L’acqua nell’ampolla è ferma da centocinquant’anni, eppure — contro luce — trema: si vede un saio inginocchiato a un fonte, un bambino che piange al battesimo, e lo stesso saio, molto dopo, che canta in un buio pieno di nicchie senza fermarsi mai. La voce del fonte è più vecchia della sua. La visione dura un rintocco.' },
    ] },
  { n: 5, nome: 'La Casa del Becchino',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'Mola, alla fine',
        testo: 'Rintracciato al cancello di servizio, Mola non nega niente: «io le ossa le SCAVO, signori. Non chiedo per chi suonano. Il maestro dei registri paga, il timbro è vero, la carta è vera — se la carta è vera, il peccato è di chi la scrive. Ditemi che è così. Vi prego: ditemi che è così.»' },
    ] },
  ...
  { n: 7, nome: 'L’Ufficio delle Sconsacrazioni',
    ...
    approfondimenti: [
      { tipo: 'Referto', soggetto: 'Il timbro prestato',
        testo: 'L’impronta del timbro sulle autorizzazioni è perfetta ma STANCA: il cuscinetto era quasi asciutto, l’impronta ribattuta due volte. Chi timbra così non lavora in Curia: timbra di fretta, altrove, con un timbro che deve RIENTRARE prima che qualcuno ne senta la mancanza. Il prestito dura una notte. Da vent’anni, quando serve.' },
    ] },
  { n: 8, nome: 'Il Deposito del Marmista',
    ...
    approfondimenti: [
      { tipo: 'Osservazione', soggetto: 'Le ultime due lapidi',
        testo: 'Le due lapidi pronte hanno le date di consegna segnate a matita sul retro, come usa il marmista: dopodomani. Chiunque paghi, verrà a ritirarle — o manderà il garzone — dopodomani. Un appuntamento, scolpito nel marmo da chi non sa di averlo dato.' },
    ] },
  { n: 9, nome: 'La Sacrestia dei Battuti',
    req: 'La porticina della sacrestia vecchia è serrata da una toppa nera di flagelli incrociati: senza la chiave giusta resta un muro — e il sagrato, di notte, non gradisce chi forza le porte dei morti.',
    art: 'artworks/Sagrestia dei Battuti.png',
    testo: 'La sacrestia vecchia è rimasta al Quarantuno: paramenti neri appesi, un inginocchiatoio, la polvere come neve. Sul tavolo, però, impronte fresche — e sotto l’armadio dei paramenti, trascinato di lato, il pavimento mostra una botola col flagello inciso.',
    approfondimenti: [
...
const EP5_OGGETTI = [
  { art: 'artworks/Acqua del Fonte.png', nome: 'L’Acqua del Fonte', ref: 'E5-L4',
    ...
    effetto: 'Un’azione adiacente al Salmodiante: l’unica voce più vecchia della sua — Difesa da 8 a 5 per il resto della partita, e salta la sua prossima attivazione.' },
  { art: 'artworks/Chiave del Sagrato.png', nome: 'La Chiave del Sagrato', ref: 'E5-L4',
    ...
    effetto: 'Apre la sacrestia vecchia dei Battuti (Luogo 9) — e la strada per la cripta.' },
...
const LUOGHI6 = [
  { n: 1, nome: 'La Cattedrale, la Sacrestia', req: 'Disponibile dall’inizio',
    art: 'artworks/nervous priest in a candlelit sacristy.png',
    testo: 'Don Callisto non finge più: «il pavimento della cripta RESPIRA, signori. E stanotte l’acqua benedetta trema nelle pile senza che nessuno la tocchi.» Sotto la sacrestia, un battito lento — sessanta colpi l’ora, come un cuore che dorme. Stanotte batte più forte.',
    approfondimenti: [
      { tipo: 'Osservazione', soggetto: 'Le mani di don Callisto',
        testo: 'Il parroco versa il vino della messa e trema — ma non di paura generica: guarda il calice come chi ha visto il vino incresparsi da solo. «Da tre notti», ammette alla fine, «alle tre e un quarto esatte, tutto ciò che è liquido in questa chiesa fa UN’ONDA. Una sola. Poi torna fermo.» Il liutaio prova l’orchestra: e l’acqua risponde già.' },
    ] },
  { n: 2, nome: 'Il Canale Basso', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'Il barcaiolo più vecchio',
        testo: '«Il liutaio l’ho portato IO, tre notti fa, alla porta d’acqua. Pagava bene e taceva meglio. Ma quando siamo passati sotto la Cattedrale ha appoggiato la mano sul fasciame, come si tasta la febbre a un figlio — e ha detto, piano: “ancora un movimento, e ti sveglio”. Non parlava con me.»' },
    ] },
  { n: 3, nome: 'Il Catasto delle Acque', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Referto', soggetto: 'Il bulbo delle vene',
        testo: 'Ricalcando le tre carte idrografiche una sull’altra, la camera appare da sola: un vuoto rotondo dove nessuna vena passa ATTRAVERSO — tutte si fermano al bordo, come radici che nutrono senza entrare. La città non è costruita SOPRA qualcosa. È costruita INTORNO.' },
    ] },
  { n: 4, nome: 'Il Palazzo del Lume', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'M., a porte chiuse',
        testo: '«Ferri è vivo. L’ho sempre saputo — dal magazzino non tornò nessun corpo, solo uno spartito lasciato a metà, e chi lascia il lavoro a metà non muore: si CONSERVA, come i suoi strumenti. Stanotte lo troverete al centro della sala, e vi sembrerà stanco e gentile. Non esitate per questo. Gli uomini stanchi e gentili sono quelli che hanno già deciso tutto.»' },
    ] },
  { n: 5, nome: 'La Bottega di Ferri, riaperta',
    ...
    approfondimenti: [
      { tipo: 'Osservazione', soggetto: 'Il banco del liutaio',
        testo: 'Gli strumenti rimasti sono in ordine perfetto, TRANNE il diapason d’argento del primo caso: il suo astuccio è aperto e vuoto, al centro del banco, in evidenza. Non è una dimenticanza: è un messaggio. Ferri sa che verrete, e vi dice: “vi ho lasciato l’astuccio. Il LA giusto, stanotte, lo do io.”' },
    ] },
  { n: 6, nome: 'La Chiusa Grande',
    ...
    approfondimenti: [
      { tipo: 'Referto', soggetto: 'Le tavole di marea',
        testo: 'Il colmo di sizigia dura undici minuti: dalle 3:15 alle 3:26. Qualunque cosa il rito debba fare con l’acqua, ha UNDICI MINUTI per farla. E qualunque cosa dobbiate fare voi, conviene che sia fatta prima: l’acqua alta non fa sconti a chi sta nelle gallerie.' },
    ] },
  { n: 7, nome: 'L’Archivio Capitolare',
    ...
    approfondimenti: [
      { tipo: 'Referto', soggetto: 'La rubrica della Formula',
        testo: 'La pergamena è del Quarantuno, ma la PIEGA è recente, e c’è una seconda piega, diversa, più vecchia di poco: il fascicolo è stato consultato DUE volte negli ultimi mesi. Qualcuno ha letto la formula prima di voi — e l’ha rimessa a posto con cura da archivista. Chiunque sia, sapeva che sareste arrivati qui. E non l’ha distrutta.' },
    ] },
  { n: 8, nome: 'Il Rifugio del Maestro dei Registri',
    ...
    approfondimenti: [
      { tipo: 'Osservazione', soggetto: 'L’impronta degli schedari',
        testo: 'Quattro impronte sul pavimento: quattro schedari. «Fonderia», «pozzi», «teatro» li avete visti. Il quarto era «cripta». Ma l’impronta più vecchia, sotto la polvere di anni, è una QUINTA — più stretta, portata via molto prima. Il Maestro dei Registri teneva un quinto conto, di cui nessuno sa niente. E lo custodiva meglio degli altri.' },
    ] },
  { n: 9, nome: 'L’Imbocco delle Tre Acque',
    ...
    approfondimenti: [
      { tipo: 'Osservazione', soggetto: 'I conci numerati',
        testo: 'La numerazione a gesso dei conci non è di mano di muratore: è la calligrafia minuta e ordinata di chi tiene registri. Il Maestro dei Registri non ha solo pagato la riapertura: l’ha DIRETTA, concio per concio, come si smonta uno strumento prezioso. Il Coro intende richiuderla, dopo. Tutto, in questo cantiere, è pensato per durare.' },
    ] },
].map((L) => ({
  art: L.art,
  title: `${L.n} · ${L.nome}`,
  ...
  { n: 2, nome: 'La Bottega di Fava', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Osservazione', soggetto: 'Il banco dell’accordatore',
        testo: 'Tra i ferri del mestiere c’è una mattonella d’intonaco, spaccata a metà, con l’etichetta di Fava: «campione, palazzone, parete ovest». Nella frattura, una polvere grigia che non è sabbia: luccica come metallo macinato. Fava non stava riparando pianoforti: stava facendo un’ANALISI. E chi analizza un brevetto, del brevetto è nemico.' },
    ] },
  ...
  { n: 4, nome: 'Il Banco dei Pegni', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'Il guardiano licenziato',
        testo: '«Una notte ho sentito battere da dentro l’intercapedine del terzo piano — tre colpi, pausa, tre colpi: uno che conta, mica un topo. L’ho detto al Capocantiere. Il giorno dopo ero in strada, e la squadra mi ha accompagnato al cancello: “le orecchie buone, qui, sono un difetto”. È stato l’ingegnere a firmare: Voltan. Il brevetto è suo, il silenzio è suo.»' },
    ] },
  ...
  { n: 4, nome: 'Il Monte di Pietà', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Referto', soggetto: 'Il registro dei riscatti',
        testo: 'I riscatti anomali dell’ultimo trimestre fanno una mappa: tutti i quartieri dei clan minori, nessun quartiere dei clan grandi. Chi paga sta comprando i PICCOLI — uno alla volta, casa per casa, come si compra un isolato prima di costruirci sopra. Questo non è racket: è un CONSOLIDAMENTO. E ha un progetto.' },
    ] },
  ...
  { n: 7, nome: 'L’Archivio dei Sequestri',
    ...
    approfondimenti: [
      { tipo: 'Referto', soggetto: 'La ceralacca fresca',
        testo: 'Il sigillo è impresso con la matrice AUTENTICA: ogni dente, ogni difetto del conio originale. Non è un falso: è un USO. Qualcuno possiede ancora la matrice demaniale del 1741, la usa per aprire e richiudere ciò che lo Stato credeva sepolto — e un’eredità così non si ruba: si riceve, d’ufficio, in silenzio. Il tesoro non fu perso. Fu CUSTODITO. (Il seme: conservatelo per la campagna.)' },
    ] },
...
const LUOGHI9 = [
  { n: 1, nome: 'Il Tribunale', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Osservazione', soggetto: 'Il banco della difesa',
        testo: 'I faldoni della difesa sono ORDINATI per la deposizione di domani: ogni obiezione già scritta, ogni testimone già smontato — compreso Riva, con una nota a lato: «ritratta o non compare». La difesa non improvvisa: sa GIÀ cosa dirà Riva, o cosa non dirà. Qualcuno gliel’ha promesso.' },
    ] },
  ...
  { n: 3, nome: 'La Pensione del Giurato', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'Amilcare Bo',
        testo: '«L’oro della parcella dell’avvocato e l’oro dei miei debiti sono lo STESSO oro: marenghi vecchi, bordi molati. Ce l’ho ancora una moneta, guardate. Chi ha comprato me ha comprato lui, e ha comprato il verdetto. Non è un avvocato che difende un cliente: è un impiegato che chiude una pratica. E la pratica siamo NOI.»' },
    ] },
  { n: 4, nome: 'La Gendarmeria', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'L’usciere del Tribunale',
        testo: '«La deposizione di domani terrorizza gente importante, signori: da quando ho nascosto Riva, mi hanno offerto uno stipendio annuo per dire dov’è. In oro vecchio. Ho detto di no — ho giurato sul Vangelo, io. Ma non tutti giurano, e il cambio di guardia di stanotte lo fa uno che ai Vangeli preferisce i marenghi.»' },
    ] },
  ...
  { n: 8, nome: 'La Locanda del Forestiero',
    ...
    approfondimenti: [
      { tipo: 'Referto', soggetto: 'Il biglietto nel cestino',
        testo: 'Carta di pregio, filigrana della cartiera già vista nei casi passati; la firma è una sola iniziale, «M.». Un’iniziale non è un nome, e in città di gente che si firma con una lettera sola ce n’è più d’una — ma la carta è questa, e si ripete di caso in caso. «Che sia pulito» a doppia lettura: uccidere senza scandalo, o far sparire senza sangue? Perfino l’ordine è ambiguo, come chi lo firma.' },
    ] },
  ...
  { n: 1, nome: 'La Casa che Ricorda', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Osservazione', soggetto: 'La parete che detta',
        testo: 'La parete della camera è più spessa delle altre di una spanna buona: battendola, in un punto suona vuota. Non è un muro pieno — è un muro DOPPIO, con un vano dietro. La voce non viene «dalla casa»: viene da quel vano. Qualcosa, o qualcuno, è murato lì da anni, e la calce che ricorda gli ha ridato la voce.' },
    ] },
  { n: 2, nome: 'La Corte della Faenza', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'La vicina di Ada',
        testo: '«Ada me lo disse, l’ultima settimana: “Corrado non mi guarda più, guarda la ragazza del fornaio”. Poi sparì, e lui pianse a favore di corte per un mese, e sposò proprio quella ragazza l’anno dopo. Abbandono, dissero. Ma una donna che scappa si porta via qualcosa. Ada lasciò tutto: l’anello, i vestiti, perfino le scarpe. Chi scappa scalza? Chi non è scappata: è stata portata via. E l’ha portata via lui.»' },
    ] },
  { n: 3, nome: 'L’Archivio Civico', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Referto', soggetto: 'La denuncia del 1879',
        testo: 'La grafia della denuncia è nervosa, l’inchiostro fu premuto forte: non la mano di chi ha perso qualcuno, ma di chi recita una parte provata. E la data — quattro giorni — è troppo presto: un marito abbandonato aspetta, spera, cerca. Denuncia in fretta solo chi ha già bisogno che l’assenza sia ufficiale. Corrado Malfanti non cercava Ada: la stava dichiarando sparita perché sapeva che non sarebbe tornata.' },
    ] },
  { n: 4, nome: 'La Gendarmeria', req: 'Disponibile dall’inizio',
    art: 'artworks/La Gendarmeria.png',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'Il brigadiere',
        testo: '«Ve lo dico fuori dai denti: dieci anni fa Malfanti denunciò l’abbandono, noi archiviammo, e lui il mese dopo fece murare una parete “per umidità” — lo scrisse pure sulla licenza dei lavori, allora. Umidità, al primo piano, sul muro asciutto verso la corte. Nessuno collegò le due cose. Io sì, stanotte, con voi che me lo chiedete. Il colpevole è lui: l’ha uccisa e l’ha murata, e ha chiamato tutto “abbandono”.»' },
    ] },
  { n: 5, nome: 'Il Deposito del Muratore',
    ...
    approfondimenti: [
      { tipo: 'Referto', soggetto: 'Gli ordini di Malfanti',
        testo: 'Il biglietto del ricatto fissa l’ora: «prima dell’alba, nell’intervallo delle ronde — entra dalla cantina, che dà sul deposito, e non farti sentire». Il muratore entrerà dal sottoscala e comincerà dal piano di sopra. Chi ha la pianta e conosce la parete doppia può andare dritto al vano senza cercarlo a tentoni — e senza mettere il piede sul gradino marcio della scala.' },
    ] },
  ...
  { n: 2, nome: 'La Pensione dei Topografi', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'Il topografo più giovane',
        testo: '«Ve lo dico perché ho paura, non per denaro. Ratti aveva rimesso in ordine le sue pagine e aveva capito: tutte le misure puntano allo stesso posto. Voleva vendere il rilievo per conto suo. Speranza lo ha saputo — se perdiamo la commessa, siamo sei uomini in mezzo a una strada. Ieri sono saliti insieme alla Torre. È sceso solo Speranza. È stato lui. Ma non prendetelo per un mostro: è solo uno che aveva più paura della fame che del sangue.»' },
    ] },
  { n: 3, nome: 'L’Archivio Civico', req: 'Disponibile dall’inizio',
    art: 'artworks/L’Archivio Civico.png',
    ...
    approfondimenti: [
      { tipo: 'Referto', soggetto: 'Il punto che non c’è',
        testo: 'Le misure di Ratti, ordinate e riportate sulla pianta, non descrivono la città: la triangolano verso un solo fuoco, un punto sotto la Cattedrale che nessuna mappa civica riconosce. Non è un censimento di campane: è un rilievo di puntamento. Qualcuno vuole sapere con precisione al palmo dove si trova quel vuoto — e da quali bocche di pietra, in tutta Roccamora, il suono ci arriverebbe sopra.' },
    ] },
...
const EP11_OGGETTI = [
  ...
  { art: 'artworks/Lanterna Cieca.png', nome: 'La Lanterna da Guglia', ref: 'E11-L6',
  ...
  { n: 5, nome: 'La Loggia dei Confratelli',
    ...
    approfondimenti: [
      { tipo: 'Osservazione', soggetto: 'La paranoia in casa',
        testo: 'La ricerca del falsario perfetto è così avvincente che nessuno considera l’alternativa più comoda: che non ci sia nessuna mano da imitare, perché a chi dispone del protocollo bastano un timbro e un’ora. Il sospetto reciproco è la vera vittoria di chi ha firmato: mentre i confratelli si contano le colpe l’uno addosso all’altro, nessuno va a leggere il registro delle ore, e la penna resta al sicuro.' },
    ] },
...
const EP12_OGGETTI = [
  { art: 'artworks/Fischietto della Ronda.png', nome: 'Il Fischietto della Ronda', ref: 'E12-L8',
    ...
    effetto: 'Ai ponti coperti (T2, T5), se il Corriere è in vista, tagliate la traccia FUGA di 1 (i gendarmi chiudono) o lo agganciate automaticamente.' },
  ...
  { n: 3, nome: 'L’Ufficio del Fermo-Posta', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Osservazione', soggetto: 'I tre compratori',
        testo: 'La carta col giglio, in città, la comprano in tre: il vescovado, la Prefettura, e questa casella riservata. Due sono facciate rispettabili che giustificano l’acquisto; la terza è il vero destinatario. Chi vuole nascondere una carta la fa comprare anche da chi non ne ha bisogno: così la sua non spicca. Il fermo-posta è la foglia nella foresta.' },
    ] },
  ...
  { n: 5, nome: 'La Casa del Capo-Catena',
    ...
    approfondimenti: [
      { tipo: 'Presagio', soggetto: 'La deposizione mai resa',
        testo: 'A leggere i suoi fogli nell’ordine giusto, la voce del capo-catena torna come da sotto l’acqua: non un fantasma, il calco di una testimonianza che nessuno ha raccolto in tempo. Vi dice tre cose — a che ora parte il nolo della carta; a che ora, stanotte, daranno fuoco ai registri; e per dove passa la guardia. È tutto quello che sarebbe morto in tribunale, se fosse arrivato vivo. Fatelo arrivare voi. Una quarta cosa l’ha scritta e non l’ha spiegata — quella fermata in più, segnata e mai sciolta: resta sulla pagina come un chiodo, e stanotte non vi serve.' },
    ] },
  { n: 6, nome: 'La Cancelleria Vescovile',
    ...
    approfondimenti: [
      { tipo: 'Osservazione', soggetto: 'Il compratore di facciata',
        testo: 'Il vescovado compra la carta col giglio alla luce del sole, per atti che la richiedono davvero: è la copertura perfetta, e involontaria. Finché esistono compratori legittimi, il compratore illegittimo non spicca. Rasca ha scelto bene la sua foresta: tre alberi identici, e solo uno nasconde il nido.' },
    ] },
...
const EP13_OGGETTI = [
  ...
  { art: 'artworks/Taccuino del Capo-Catena.png', nome: 'Il Taccuino del Capo-Catena', ref: 'E13-L5',
    ...
    effetto: 'L’arbitro fa scattare il rogo 2 round più tardi (arrivate col fuoco più lontano) e rende Facili le prove d’ambiente del molino (roggia, macine, telai). Non si somma alla Domanda 3 esatta: è lo stesso vantaggio, 2 round in tutto, mai 4.' },
  ...
  { n: 1, nome: 'La Villa-Museo di Braga', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'Il professor Braga',
        testo: '«Ve lo dico da criminologo, non da derubato: guardate cosa manca, sì, ma guardate meglio cosa {i}resta{/i}. Un ladro professionista che restituisce è una contraddizione in termini. O il colpo è fallito — e non pare — o non era un furto: era un pretesto per {i}mettermi in casa{/i} qualcosa. Io ho i guanti da quarant’anni proprio per non lasciare traccia. Qualcuno vuole che ne lasci una. Chiedetevi chi, tra quelli che mi conoscono da una vita.»' },
    ] },
  { n: 2, nome: 'La Gazzetta di Roccamora', req: 'Disponibile dall’inizio',
    art: 'artworks/Gazzetta di Roccamora.png',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'Il cronista Ranuzzi',
        testo: '«Fiuto le storie, e questa puzza. Due criminologi rivali, un furto che torna indietro, e la città che non aspetta altro che vedere uno dei due nel fango. Se fossi in voi mi chiederei non chi ha rubato — quello lo so io, i gatti del Corso — ma chi VUOLE questa storia sui giornali. Perché una storia così non nasce da sola: qualcuno la sta scrivendo, e la scrive perché finisca su Braga.»' },
    ] },
  ...
  { n: 7, nome: 'Il Faldone d’Inventario',
    ...
    approfondimenti: [
      { tipo: 'Referto', soggetto: 'La prima pietra del falso',
        testo: 'Il Verbale d’Inventario è il capolavoro involontario del falsario: non ha dovuto corrompere nessun gendarme, gli è bastato far trovare gli oggetti giusti e lasciare che la burocrazia li rendesse reali. Il Sigillo «C.B.» è ora un fatto agli atti: quando, tra qualche giorno, arriverà un dossier che accusa Braga, questo faldone sarà la sua prima conferma. È così che si costruisce un colpevole: non con una bugia, ma con una serie di verità piccole e vere, messe dove servono.' },
    ] },
  ...
  { n: 9, nome: 'L’Attico del Corso',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'Lo Spillo, sulla cresta',
        testo: '«Di solito ci pagano per portar via, signori. Stavolta metà oro era per {i}lasciare{/i}: roba non sua, da mettere nelle casse del professore con cura, dove i vostri gendarmi l’avrebbero pescata. Non so chi paga — oro vecchio, un intermediario mai visto, ricevute su carta col giglio. Ma so una cosa: chi ordina un furto per {i}arredare{/i} una casa d’altri non vuole rubare. Vuole che quell’uomo sia colpevole. E per farlo bene, lo conosce da una vita.»' },
    ] },
].map((L) => ({
  art: L.art,
  title: `${L.n} · ${L.nome}`,
...
const LUOGHI15 = [
  ...
  { n: 4, nome: 'La Stanza del Testimone', req: 'Disponibile dall’inizio',
    ...
    testo: 'Il testimone oculare che ha «visto» Braga: sicuro, preciso, senza un’esitazione. E vi dà una cosa che nessuno poteva suggerirgli — prima di prendere in mano una carta, il professore si asciugava due dita nel risvolto della manica. Lo mima, e lo mima bene: non sta in nessun foglio del dossier.',
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'Il testimone istruito',
        testo: '«Me l’hanno fatta imparare» gli scappa, e poi si corregge. È tutto lì. Il testimone oculare non mente su ciò che ha visto: mente sull’aver visto. È stato istruito, pagato o spaventato, e recita una parte scritta da altri — la stessa mano che ha scritto il dossier. Un testimone vero è la crepa di un caso; questo ne è il cemento. Chi lo ha preparato sapeva esattamente quale tassello mancava, e l’ha fabbricato.' },
    ] },
  { n: 5, nome: 'L’Archivio dei Manuali',
    ...
    approfondimenti: [
      { tipo: 'Presagio', soggetto: 'La copia consultata',
        testo: 'Dodici copie, tutte presenti, tutte censite, e lo scaffale intatto. Ma la n. 7 non è tornata come ne era uscita: riletta fino alla piega, sottolineata a matita leggera su un capitolo solo — quello sulla grafia. Sul registro, alla sua riga, la data del mese scorso e una firma raschiata via con la punta di un temperino; sotto, l’impronta della penna sul foglio seguente, che non dice niente. Qualcuno ha ripassato la lezione poco prima che il dossier nascesse, e ha voluto che non risultasse.' },
    ] },
  { n: 6, nome: 'Lo Studio del Perito',
    ...
    approfondimenti: [
      { tipo: 'Osservazione', soggetto: 'La falsa conferma',
        testo: 'Di Coda si butta via tutto tranne la cosa che pesa. La deposizione che si offre di dare non vale niente: quella notte non c’era, e giurerebbe il falso per rancore, così che l’accusa abbia più voci. La perizia è un’altra cosa: è fatta a regola d’arte, e dice che quella è la mano di Braga. Resta un dettaglio che nessuno gli ha chiesto: a sollecitarlo, ieri, non è stata la Gendarmeria — qualcuno, fuori dalle carte, dispone anche le voci.' },
    ] },
...
const LUOGHI16 = [
  { n: 1, nome: 'La Casa del Lampionaio', req: 'Disponibile dall’inizio',
    ...
    testo: 'Povera, pulita, con una fotografia di Nina sul comò e un uomo che accende ancora i lumi ogni sera, come se la figlia potesse tornare a vederli. Qui nasce il nastro verde: un pegno segreto tra un padre e una figlia.',
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'Il lampionaio',
        testo: '«Ve lo dico perché mi pesa sul cuore: il nastro verde al polso di Nina era un segreto tra me e lei, un pegno di compleanno, mai detto ad anima viva. Eppure il signore della vostra Società lo sapeva, ieri, prima ancora che voi arrivaste. Io non capisco queste cose. Ma voi che indagate — chiedetevi come fa un uomo a sapere un segreto che nessuno gli ha detto. Io, la notte, non dormo più a pensarci.»' },
    ] },
  { n: 2, nome: 'Il Caffè degli Annunci', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'La cameriera del caffè',
        testo: '«Non è la prima, sa. Ne ho viste altre, negli anni, sedersi a quel tavolo con lo stesso tipo di uomo, la stessa luce negli occhi, e poi sparire nel nulla o tornare rovinate. Lo sposo perfetto cambia faccia e nome, ma è sempre lo stesso mestiere: promette nozze, si fa firmare la dote, e via. Non è un mostro dei vostri, signori. È solo un uomo che ha fatto del cuore delle ragazze un commercio.»' },
    ] },
  { n: 3, nome: 'La Gazzetta di Roccamora', req: 'Disponibile dall’inizio',
    art: 'artworks/Gazzetta di Roccamora.png',
    testo: 'Tiene la memoria della città: gli annunci, e le sparizioni che li seguono negli anni. Una scia di ragazze rovinate e doti sparite — la firma dello Sposo. E l’incrocio di Ranuzzi: negli ultimi colpi c’è sempre una carrozza per il lago.',
    approfondimenti: [
      { tipo: 'Osservazione', soggetto: 'La scia dello Sposo',
        testo: 'Incrociate gli annunci e le sparizioni: lo Sposo è un seriale prevedibile, quasi noioso nella sua meccanica. Villa affittata sul lago, promessa di nozze, dote firmata, fuga dall’altra sponda. Nessun mistero, nessuna ombra: un mestiere ripetuto tante volte da diventare prevedibile — e la prevedibilità è l’unica cosa di lui che potete usare. Sapete dove porta le ragazze e sapete cosa aspetta per sparire: la firma sulla dote. Finché quella carta non è firmata, Nina gli serve viva e contenta.' },
    ] },
  { n: 4, nome: 'La Stazione delle Carrozze', req: 'Disponibile dall’inizio',
    art: 'artworks/La Stazione delle Carrozze.png',
    testo: 'Snodo dei trasporti: da qui, tre giorni fa, sono partiti Nina e il suo «fidanzato», carrozza per il lago. Il capostazione ricorda la risata e i guanti lunghi della festa — delle mani non ha visto niente — e le notti in cui l’uomo tornava indietro da solo.',
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'Il capostazione',
        testo: '«La ragazza me la ricordo bene, ma non per la faccia: rideva come chi non ha mai preso una vettura per andare lontano, e lui la teneva per il gomito con la cortesia che si usa coi bauli. Le facce non le tengo a mente, signori, tengo a mente gli orari. E la carrozza per il lago era quella di sempre, la villa dei Càrpine sulla sponda di ponente. Un’ora scarsa da qui. Se cercate la piccola del lampionaio, è là che l’hanno portata: non a nozze, ma a marcire finché lui non ha in mano la dote.»' },
    ] },
  { n: 5, nome: 'La Casa dell’Ex Fidanzata',
    ...
    approfondimenti: [
      { tipo: 'Presagio', soggetto: 'Il male con una misura',
        testo: 'Nella casa di questa donna il male ha una faccia piccola e un nome — anzi dieci nomi, tutti falsi. Dopo mesi di ombre senza volto, di C.B. che non si lascia toccare, fa quasi tenerezza un cattivo così: prevedibile, meschino, umano. Un male con una misura si prende in una sera, e stasera basterà. Eppure, scendendo quelle scale, vi resta addosso il freddo di una cosa piccola che non torna — e non riguarda quest’uomo.' },
    ] },
  { n: 6, nome: 'L’Archivio delle Lettere',
    ...
    testo: 'Il Taccuino e le vecchie lettere d’incarico di M.: non le vostre copie, le sue minute — compresa la prima, quella che vi ordinò di bruciare. È qui che debutta la RILETTURA, e qui che la crepa si apre: la lettera di stanotte nomina il nastro verde, un segreto che il presidente non poteva sapere.',
    approfondimenti: [
      { tipo: 'Referto', soggetto: 'La firma nelle lettere',
        testo: 'Il nastro verde non è un caso isolato. Rileggete le lettere d’incarico di M. dal primo giorno, e ognuna nasconde un dettaglio che lui non poteva sapere per vie oneste: il nome di un colpevole prima delle prove, un luogo prima della scoperta, un morto prima del ritrovamento. Uno alla volta, li avete letti come genio deduttivo. Tutti insieme, sono altro: sono un uomo che sa perché è lui a muovere le cose. Rileggete tutto: ogni lettera riletta è un mattone per il giorno in cui lo chiederete a lui, al massimo 3 per sessione.' },
    ] },
  { n: 7, nome: 'Il Fioraio',
    ...
    testo: 'Dove lo sposo perfetto comprava sempre le stesse rose bianche, ogni volta per una ragazza diversa. Un vicolo cieco profumato: bello, inutile — ma buono a misurare l’uomo che lo percorre.',
    approfondimenti: [
      { tipo: 'Osservazione', soggetto: 'Le rose dell’inganno',
        testo: 'Le rose bianche sono lo strumento del mestiere: fanno credere all’amore chi ha voglia di crederci. Il fioraio è l’unico che ha visto lo Sposo da vicino, ma non serve a nulla — dieci nomi, dieci facce. La pista dei fiori porta solo alla villa, che già conoscete: un vicolo cieco profumato. Serve però a misurare l’uomo: paga in contanti, ordina sempre lo stesso mazzo, non lascia mai un indirizzo. Non è audacia, è abitudine — e l’abitudine è la sola cosa per cui lo si aspetta al varco.' },
    ] },
...
const EP16_MINACCE = [
  ...
  { art: 'artworks/Le luci si accendono.png', title: 'Le Luci si Accendono', tipo: 'Crescendo',
    ...
    effect: 'Aggiungete 1 segnalino Canto (l’allarme). Lo Sposo comincia a muovere Nina verso l’imbarcadero (T5).' },
  ...
  { art: 'artworks/La barca è slegata.png', title: 'La Barca è Slegata', tipo: 'Crescendo',
    ...
    effect: 'Aggiungete 1 segnalino Canto (l’allarme). Se lo Sposo raggiunge l’imbarcadero con Nina sotto l’inganno, tenta la fuga in barca (vedi Soluzione). Mostratele il Fascicolo ORA, se l’avete.' },
...
const EP16_OGGETTI = [
  { art: 'artworks/Fascicolo delle Vittime.png', nome: 'Il Fascicolo delle Vittime', ref: 'E16-L5',
    ...
    effetto: 'Mostrato a Nina (T6, o già al Salone T4): la bugia delle nozze crolla, lei si stacca dallo Sposo — CATTURA AUTOMATICA (vittoria pulita), niente fuga in barca.' },
  { art: 'artworks/Lettera di M.png', nome: 'La Lettera di M.', ref: 'E16-L6',
    fonte: 'Luogo 6 — L’Archivio delle Lettere',
    flavor: 'La lettera d’incarico di stanotte: nomina «la piccola col nastro al polso», un segreto che nessuno ha confidato al presidente. La crepa.',
    effetto: 'Il seme più pesante della campagna. Abilita la RILETTURA sul Mazzo delle Minute: ogni lettera riletta banca un incrocio, al massimo 3. Nessun vantaggio meccanico in questo episodio.' },
  { art: 'artworks/Mazzo delle Minute.png', nome: 'Il Mazzo delle Minute', ref: 'E16-L6',
    fonte: 'Luogo 6 — L’Archivio delle Lettere',
    flavor: 'Le minute delle vecchie lettere d’incarico di M., legate con la fettuccia, un mazzo per stagione. Non le vostre copie: le sue.',
    effetto: 'Portatelo al Taccuino per la RILETTURA: ogni lettera riletta banca un incrocio di campagna, al massimo 3 per sessione.' },
  ...
  { n: 1, nome: 'Lo Studio del Decano', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Presagio', soggetto: 'La perquisizione educata',
        testo: 'Chi ha messo a soqquadro lo studio del decano non era un ladro né un rapitore comune: sapeva cosa cercare (il dossier cifrato) e aveva tempo e chiavi. Non ha rotto nulla, non ha rubato i valori, non ha lasciato tracce di scasso. È entrato come si entra in casa propria. E l’ultimo appunto del decano lo dice chiaro: non temeva una talpa. Temeva chi la talpa la avrebbe inventata — per spiegare la sua sparizione senza sospetti su di sé.' },
    ] },
  { n: 2, nome: 'L’Assemblea della Società', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'Il confratello anziano',
        testo: '«Ve lo dico sottovoce perché ho paura: la caccia alla talpa è cominciata troppo in fretta, troppo sicura. Il presidente sapeva del traditore prima di cercarlo — perché il traditore non esiste. È una storia che serve a spiegare perché il decano è sparito, e a tenere ogni indizio nelle mani di M. Il decano non è stato venduto da uno di noi: è stato preso su ordine di chi ora ci aizza gli uni contro gli altri. Guardate l’ultimo lavoro del Notaio, e capirete.»' },
    ] },
  ...
  { n: 4, nome: 'Lo Studio del Notaio', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'Il praticante del Notaio',
        testo: '«Il Notaio Rasca è l’uomo che fa sparire le persone con le carte in regola: un affitto, un nolo, una custodia “riservata”, e nessuno può dire che sia un rapimento. L’ultimo lavoro è il decano: preso, portato alla villa fuori porta, interrogato con garbo per sapere quanto sa la Società. Non c’è talpa, signori. C’è un notaio che esegue e un cliente che paga. E il cliente, giuro su Dio, non è fuori dalla vostra Società. È in cima.»' },
    ] },
  ...
  { n: 6, nome: 'Il Membro Interno',
    ...
    approfondimenti: [
      { tipo: 'Osservazione', soggetto: 'La talpa fabbricata',
        testo: 'La talpa è un capolavoro di scena, come il caso Braga: indizi troppo puliti, spuntati troppo al momento giusto, contro un innocente incapace di difendersi. Serve a due cose: dare alla Società un colpevole da odiare (così nessuno cerca più in alto), e tenervi occupati a processare un povero confratello mentre il decano viene interrogato e il Notaio copre le tracce. Seguire la talpa fittizia è perdere. La vera domanda non è chi sia la talpa. È perché a qualcuno serva tanto che ce ne sia una.' },
    ] },
  { n: 7, nome: 'La Dogana Vecchia',
    ...
    approfondimenti: [
      { tipo: 'Referto', soggetto: 'La carrozza che torna vuota',
        testo: 'La carrozza chiusa del Notaio è passata alla Dogana la notte scorsa, diretta a una villa fuori porta, con un «trasferimento riservato» a bordo: il decano. Le carte erano in regola, come sempre con Rasca — perché il suo mestiere è far sembrare legale ciò che non lo è. Il doganiere lo sa, e ha paura: dice che le carrozze chiuse del Notaio, di solito, tornano vuote. Il decano è ancora vivo solo perché serve, per ora, a sapere quanto sapete voi. Fate presto.' },
    ] },
...
const EP17_MINACCE = [
  ...
  { art: 'artworks/Rasca dà l’ordine.png', title: 'Rasca dà l’Ordine', tipo: 'Crescendo',
    ...
    effect: 'Aggiungete 1 segnalino Canto (il Trasferimento). Alla soglia-decano (Canto 6, 7 col Salvacondotto): il decano è trasferito — vedi Soluzione. Alla soglia-Canto (3): +1 carta Minaccia per Fase, per sempre.' },
...
const LUOGHI18 = [
  ...
  { n: 2, nome: 'L’Archivio delle Penne', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Referto', soggetto: 'L’inchiostro del presidente',
        testo: 'L’inchiostro ferro-gallico della penna d’archivio del presidente è identico, ricetta per ricetta, a quello di ogni firma di C.B.: lo stesso calamaio. E il vezzo della mano — l’esitazione prima della maiuscola — è lo stesso in «M.» e in «C.B.». Resta l’ora in margine agli ordini: ma quella è l’ora del timbro, non della penna. Il protocollo lo batte un impiegato, la mattina dopo. L’alibi non è falso: è stato letto male.' },
    ] },
  { n: 3, nome: 'La Contabilità della Società', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Referto', soggetto: 'L’oro d’una cassa sola',
        testo: 'L’oro d’antica fusione che paga C.B. e quello che finanzia la Società escono dalla stessa cassa, senza mai un conflitto, senza mai un lotto conteso. Due imprese rivali si contendono le risorse; queste due si spartiscono l’oro come un uomo si sposta la borsa da una tasca all’altra. Non è collusione tra due poteri: è un potere solo che finge di essere due. Il presidente non finanzia C.B.: il presidente È il bilancio di C.B.' },
    ] },
  ...
  { n: 7, nome: 'La Matrice del Decano',
    ...
    approfondimenti: [
      { tipo: 'Referto', soggetto: 'La logistica di una mano sola',
        testo: 'La matrice del decano, incrociata con la carrozza dei noli, chiude la Domanda 3: una sola carrozza, una sola ora, un solo cortile — quello del Palazzo — servono due maschere che fingono di non conoscersi. C.B. non ha una logistica sua: usa quella della Società, perché sono la stessa impresa. Il decano l’aveva capito, e per questo se lo sono portato via: l’ha pagata di persona, e ne è uscito vivo per un soffio. La sua matrice, ora, trasforma diciotto mesi di riletture in una sola, incontestabile deduzione.' },
    ] },
  { n: 8, nome: 'Il Vezzo delle Firme',
    ...
    testo: 'Le due firme a confronto: «M.» e «C.B.», lo stesso allungo, la stessa esitazione prima della maiuscola. Il Machiavelli e Camillo Benso, le due maschere che «hanno fatto l’Italia in due». Non c’è più niente da scoprire: c’è un nome che sapete già, e adesso avete di che reggerlo.',
    approfondimenti: [
      { tipo: 'Osservazione', soggetto: 'Il Machiavelli e il contabile',
        testo: 'Guardate i due nomi per esteso, prima delle firme. «M.» sta per il Machiavelli — il soprannome che si è dato lui e che si fa ripetere dai confratelli come un titolo; «C.B.» sta per Camillo Benso. Il cospiratore e il contabile, «quelli che hanno fatto l’Italia in due». Nessuno si battezza due volte per caso: i nomi dicono, prima di ogni perizia, che non sono due uomini ma le due maschere di uno solo, e che quest’uomo si crede un padre della patria. Chi si crede l’Italia intera non fugge per paura: si ritira per continuare l’opera.' },
    ] },
  { n: 9, nome: 'Il Palazzo del Lume (la fuga)',
    ...
    approfondimenti: [
      { tipo: 'Presagio', soggetto: 'La casa che si spegne',
        testo: 'La vostra casa, stanotte, vi si volta contro: le sue luci si spengono a una a una sotto la mano che l’ha sempre governata, e i suoi corridoi — che credevate di conoscere — nascondono passaggi che erano solo di M. Non è più una spedizione: è una fuga. Il cacciatore è diventato preda, in casa propria, tradito da chi gli apriva la porta. Portate fuori la prova, e sopravvivete all’accusa: perché domani, con la firma doppia in mano, sarete voi a dare la caccia — e M., per la prima volta in diciotto mesi, dovrà scappare.' },
    ] },
].map((L) => ({
  art: L.art,
  title: `${L.n} · ${L.nome}`,
...
const EP18_MINACCE = [
  ...
  { art: 'artworks/Lo specchio del corridoio.png', title: 'Lo Specchio del Corridoio', tipo: 'Insidia',
    flavor: 'Uno specchio nel buio vi restituisce la vostra faccia, e per la prima volta vi sembra colpevole.',
  ...
  { art: 'artworks/Il maggiordomo sa dove siete.png', title: 'Il Maggiordomo sa Dove Siete', tipo: 'Insidia',
    flavor: 'Amedeo conosce ogni angolo: indica ai gendarmi la vostra stanza.',
  ...
  { art: 'artworks/Le uscite si sigillano.png', title: 'Le Uscite si Sigillano', tipo: 'Crescendo',
    ...
    effect: 'Aggiungete 1 segnalino Canto (la Rete). Se la soglia-arresto è superata, da ora ogni round un eroe rischia l’arresto: prova NERVI (Media) o «catturato», fuori scena.' },
...
const EP18_OGGETTI = [
  ...
  { art: 'artworks/Incroci di Campagna.png', nome: 'Gli Incroci di Campagna', ref: 'E18-L4',
    ...
    flavor: 'Diciotto mesi di indizi che si tengono per mano: 4 dai Bivi (9, 12, 14, 16) più 3 dalle riletture, massimo 7. Più ne avete, più la prova è pubblica.',
    effetto: 'La forza della prova. 5+ = FORTE: la Società vi crede (evento-favore garantito a T1) e uscire con la prova = M. latitante, non voi (piena). 3-4 = sufficiente: piena solo senza eroi arrestati. 0-2 = debole: al massimo parziale.' },
...
const LUOGHI19 = [
  ...
  { n: 3, nome: 'La Gazzetta di Roccamora', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Testimonianza', soggetto: 'Il cronista Ranuzzi',
        testo: '«L’Ispettore Vidal non è un uomo di M.: è un uomo onesto a cui M. ha dato in mano un dossier perfetto, esattamente come ha fatto con Braga. È il metodo, sempre lo stesso: non corrompere il migliore, ingannalo. E un uomo onesto ingannato è più pericoloso di dieci sicari, perché ci crede. Ma è anche la vostra unica speranza: mostrategli come è stato usato — la matrice del decano, il metodo di M. — e forse l’onestà che lo rende pericoloso lo farà passare dalla vostra parte. Non uccidetelo. Convincetelo.»' },
    ] },
  { n: 4, nome: 'La Gendarmeria', req: 'Disponibile dall’inizio',
    art: 'artworks/La Gendarmeria.png',
  ...
  { n: 6, nome: 'Il Decano Ferrante',
    ...
    approfondimenti: [
      { tipo: 'Presagio', soggetto: 'La crepa del coro',
        testo: 'Il decano, se lucido, vi dà la chiave tattica del finale: Ferri, ai suoi dodici, offriva almeno una fede; M. paga e non ha nulla da offrire, e un uomo pagato per cantare uno spartito che non capisce, alla prima crepa, scappa. È la debolezza del Quarto Movimento, e sarà la vostra arma nell’ultima discesa. Ma la crepa è anche più profonda: a M. manca la voce che CREDA, e senza quella il rito non si compie. Voi non dovete vincere una battaglia: dovete impedire che una sola persona canti con l’anima. Cercatela prima di lui.' },
    ] },
...
const EP19_OGGETTI = [
  ...
  { art: 'artworks/Prove per l’Ispettore.png', nome: 'Le Prove per l’Ispettore', ref: 'E19-L4',
    ...
    effetto: 'Alla Sala di Lettura (T5), all’Ispettore fermato: con queste e un conto di almeno 3 alleati lo CONVINCETE (dalla vostra parte, vittoria piena).' },
  ...
  { n: 1, nome: 'La Cattedrale (la soglia)', req: 'Disponibile dall’inizio',
    ...
    approfondimenti: [
      { tipo: 'Presagio', soggetto: 'La bocca della discesa',
        testo: 'La Cattedrale è la soglia dell’ultima notte. Sotto, oltre il punto dove fermaste Ferri nel Terzo Movimento, la gola della città aspetta il picco delle maree di sizigia per aprirsi. Non è un luogo da indagare: è una porta da attraversare, coi Frammenti in pugno. Perché là sotto non servono lame né deduzioni su chi o come — serve sapere una cosa sola: come si canta un dio a dormire senza sogni. E quella cosa è scritta, riga per riga, in ciò che avete raccolto in venti serate senza saperlo.' },
    ] },
...
const EP20_OGGETTI = [
  { art: 'artworks/Frammenti del Controcanto.png', nome: 'I Frammenti del Controcanto', ref: 'E20-L4',
    ...
    flavor: 'Le righe giuste tra i venti Frammenti di campagna: nove erano il canto del sonno, che M. voleva; gli altri undici lo smascheravano, e non l’ha mai saputo.',
    effetto: 'La deduzione finale. Servono 10 righe di controcanto. Nella camera (T6), il controcanto avanza di 1 riga + 1 ogni 6 Frammenti conservati e non incrinati per round: più ne avete, più cantate giusto.' },
